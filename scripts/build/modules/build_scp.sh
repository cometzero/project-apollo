...
build_scp()
{
    ...
    run_cmake_configure_if_needed scp-configure "${SCP_BUILD_DIR}" cmake \
        ...
        -DSCP_ENABLE_GIC_POWER_TEST="${SCP_ENABLE_GIC_POWER_TEST:-0}" \
        -DSCP_ENABLE_SCMI_PFDI_MONITOR="${PFDI_MONITOR_SUPPORT}" \
        -DSCP_PC_CONFIGURED_CORES_COUNT="${PC_CPUS_COUNT}" \
        -DSCP_PFDI_OOR_PERIOD_US="${SCP_PFDI_OOR_PERIOD_US}" \
        -DSCP_PFDI_BOOT_TIMEOUT_US="${SCP_PFDI_BOOT_TIMEOUT_US}" \
        -DSCP_PFDI_ONLINE_TIMEOUT_US="${SCP_PFDI_ONLINE_TIMEOUT_US}" \
        -DSCP_SICL1_PFDI_OOR_PERIOD_US="${SCP_SICL1_PFDI_OOR_PERIOD_US}" \
        -DSCP_SICL1_PFDI_BOOT_TIMEOUT_US="${SCP_SICL1_PFDI_BOOT_TIMEOUT_US}" \
        -DSCP_SICL1_PFDI_ONLINE_TIMEOUT_US="${SCP_SICL1_PFDI_ONLINE_TIMEOUT_US}" \
