...
ZEPHYR_MODULES_LIST="${ZEPHYR_MODULES_LIST:-${ZEPHYR_HSOC_SRC}/config/apollo-cl1-modules.list}"
...
NEXIOS_BSP_INIT_DIR="${NEXIOS_BSP_INIT_DIR:-${ROOT_DIR}/hsoc-stack/yocto/meta-hsoc-auto-solutions/recipes-core/initrdscripts/nexios-bsp-init}"
...
LOCAL_BUILD_BOOTARGS_PREFIX="${LOCAL_BUILD_BOOTARGS_PREFIX:-console=ttyAMA0,115200 earlycon=pl011,0x1A400000 rw rdinit=/init loglevel=7}"
...
BUILDROOT_EXTERNAL="${ROOT_DIR}/scripts/build/buildroot-external"
...
BUILDROOT_LINUX_CONFIG="${BUILDROOT_BUILD_DIR}/apollo-linux.config"
PFDI_BSP_CONFIG_DIR="${WORK_DIR}/pfdi-bsp-config"
PFDI_BSP_CONFIG_PACK="${PFDI_BSP_CONFIG_PACK:-${PFDI_BSP_CONFIG_DIR}/pfdi_test_config_0.pack}"
...
LOCAL_BUILD_MISC_IMAGE="${LOCAL_BUILD_MISC_IMAGE:-${YOCTO_DEPLOY_DIR}/auto-ad-nexios-misc-default.bin}"
LOCAL_BUILD_UKI_STUB="${LOCAL_BUILD_UKI_STUB:-${YOCTO_DEPLOY_DIR}/linux${EFI_ARCH:-aa64}.efi.stub}"
LOCAL_BUILD_UKI_A="${LOCAL_BUILD_UKI_A:-${BOOT_DIR}/${AUTO_AD_NEXIOS_UKI_A:-auto-ad-nexios-a.efi}}"
LOCAL_BUILD_UKI_B="${LOCAL_BUILD_UKI_B:-${BOOT_DIR}/${AUTO_AD_NEXIOS_UKI_B:-auto-ad-nexios-b.efi}}"
LOCAL_BUILD_SLOT_METADATA_A="${LOCAL_BUILD_SLOT_METADATA_A:-${LOCAL_BUILD_UKI_A}.metadata}"
LOCAL_BUILD_SLOT_METADATA_B="${LOCAL_BUILD_SLOT_METADATA_B:-${LOCAL_BUILD_UKI_B}.metadata}"
