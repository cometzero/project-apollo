...
CHECKS = {
    "memory": [
        ...
        ("platform:qvp-system-mgmt-aliases", "QBOX_PLATFORM_DIR/platforms/apollo/apollo-qvp.lua", r"system_mgmt\.add_ap_logical_mhu_aliases"),
        ("platform:si-cl0-router", "QBOX_PLATFORM_DIR/platforms/apollo/hw-block/si_cl0.lua", r"platform\.si_cl0_router"),
        ("platform:si-cl0-system-bridge", "QBOX_PLATFORM_DIR/platforms/apollo/hw-block/si_cl0.lua", r"platform\.si_cl0_system_bridge"),
        ...
        ("platform:si-cl0-hipc-bridge", "QBOX_PLATFORM_DIR/platforms/apollo/hw-block/si_cl0.lua", r"platform\.si_cl0_hipc_bridge"),
        ...
        ("platform:si-cl1-system-bridge", "QBOX_PLATFORM_DIR/platforms/apollo/hw-block/si_cl1.lua", r"platform\.si_cl1_system_bridge"),
