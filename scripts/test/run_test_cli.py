...
USAGE = "\n".join(
    (
        ...
        "Default behavior: inspect the active Apollo Yocto config, resolve the",
        "non-Xen validation suite, run static/project/QBox extras, then run",
        "FVP/OEQA runtime lanes unless --dry-run, --list, --preflight-only, or",
        "--skip-runtime is selected.",
        "",
        "Options:",
        ...
        "  --list                    List resolved validation suites only",
        ...
        "  --timeout-fvp SECONDS     FVP timeout for later runtime lanes",
        ...
        "",
        "Result paths:",
        "  manifest.json, plan.json, excluded.json, commands.jsonl, summary.json",
