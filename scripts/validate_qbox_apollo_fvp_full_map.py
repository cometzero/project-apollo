...
CHECKS = {
    "memory": [
        ...
        ("platform:full-lua", "tools/qbox/platforms/apollo-fvp/full.lua", r"fvp-rd-aspen-rse/conf\.lua"),
        ("platform:ap-view-router", "tools/qbox/platforms/apollo-fvp/full.lua", r"ap_view_router"),
        ("platform:ap-atu-in-ap-view", "tools/qbox/platforms/apollo-fvp/full.lua", r"host_ap_atu\.translation_socket\.bind\s*=\s*[\r\n ]*\"&ap_view_router\.initiator_socket\""),
        ("platform:ap-dram-in-ap-view", "tools/qbox/platforms/apollo-fvp/full.lua", r"bind_ap_socket\(platform\.host_ap_dram1,\s*\"target_socket\"\)"),
        ("platform:ap-gic-in-ap-view", "tools/qbox/platforms/apollo-fvp/full.lua", r"bind_ap_socket\(platform\.ap_gic,\s*\"dist_iface\"\)"),
        ("platform:ap-gpex-in-ap-view", "tools/qbox/platforms/apollo-fvp/full.lua", r"bind_ap_target\(platform\.ap_gpex_0\.ecam_iface\)"),
        ("platform:ap-virtio-in-ap-view", "tools/qbox/platforms/apollo-fvp/full.lua", r"bind_ap_target\(virtio\.mem\)"),
        ("platform:ap-rtc-in-ap-view", "tools/qbox/platforms/apollo-fvp/full.lua", r"bind_ap_socket\(platform\.ap_rtc_0,\s*\"mem\"\)"),
        ("platform:ap-rse-mhu-pbx-logical", "tools/qbox/platforms/apollo-fvp/full.lua", r"AP_RSE_SECURE_MHU_PBX_LOGICAL_BASE\s*=\s*0x40680000"),
        ("platform:ap-rse-mhu-mbx-logical", "tools/qbox/platforms/apollo-fvp/full.lua", r"AP_RSE_SECURE_MHU_MBX_LOGICAL_BASE\s*=\s*0x406B0000"),
