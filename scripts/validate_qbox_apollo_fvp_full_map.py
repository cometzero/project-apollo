...
CHECKS = {
    "memory": [
        ...
        ("platform:rse-helper-return", "tools/qbox/platforms/apollo/hw-block/rse.lua", r"add_ap_logical_mhu_aliases\s*=\s*function"),
        ...
        ("platform:ap-rse-mhu-pbx-logical", "tools/qbox/platforms/apollo/hw-block/rse.lua", r"AP_RSE_SECURE_MHU_PBX_LOGICAL_BASE\s*=\s*0x40680000"),
        ("platform:ap-rse-mhu-mbx-logical", "tools/qbox/platforms/apollo/hw-block/rse.lua", r"AP_RSE_SECURE_MHU_MBX_LOGICAL_BASE\s*=\s*0x406B0000"),
