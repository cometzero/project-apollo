...
Source: <https://developer.arm.com/documentation/107612/0001/Operations-of-MHU-320AE/Reliability--Accessibility--and-Serviceability/Error-handling-records/MHU-Receiver-FIFO-channel-data-RAM-error-records-8-and-9>
...
<table>
 <caption>
  <span class="documents-tablecap">
   ...
   Receiver FIFO channel data RAM errors, records 8 and 9
  </span>
 </caption>
 <colgroup>
  <col span="1"/>
 ...
 <thead>
  <tr>
   <th class="documents-nocellnorowborder" colspan="1" id="d63561e136" rowspan="1">
    <p>
     Record
    </p>
   </th>
   <th class="documents-cell-norowborder" colspan="1" id="d63561e140" rowspan="1">
    <p>
 ...
 <tbody>
  <tr>
   ...
   <td class="documents-cell-norowborder" colspan="1" rowspan="1">
    <p>
     Bit location, bits [n+7:n] Address, bits [n-1:0]
    </p>
    <p>
     where
     <code>
      n = ceil(log2(NUM_FIFO_CHAN*FIFO_CHAN_DEPTH/16))
     </code>
    </p>
   </td>
  </tr>
...
`ID = floor((16*address)/FIFO_CHAN_DEPTH)`
