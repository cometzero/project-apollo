# PBX_FEAT_SPT0, Postbox Feature Support 0 Register

Source: <https://developer.arm.com/documentation/107612/0001/Programmers-model-for-MHU-320AE/MHU-Sender-registers/MHU-Sender-Postbox-register-summary/PBX-FEAT-SPT0--Postbox-Feature-Support-0-Register>

### PBX\_FEAT\_SPT0, Postbox Feature Support 0 Register
...
Figure 1. MHUS.PBX\_PBX\_FEAT\_SPT0 bit assignments

![mhus.pbx_pbx_feat_spt0 bit assignments](images/0102-PBX_FEAT_SPT0-Postbox-Feature-Support-0-Register-img01.svg)

<table id="mhus_pbx_pbx_feat_spt0__apbx_feat_spt0-0">
 <caption>
  <span class="documents-tablecap">
   <span class="documents-table--title-label">
    Table 1.
   </span>
   PBX_FEAT_SPT0 bit descriptions
  </span>
 </caption>
 <colgroup>
  <col span="1"/>
 ...
 <thead>
  <tr>
   <th class="documents-nocellnorowborder" colspan="1" id="d1547e151" rowspan="1">
    Bits
   </th>
   <th class="documents-nocellnorowborder" colspan="1" id="d1547e154" rowspan="1">
    Name
   </th>
   <th class="documents-nocellnorowborder" colspan="1" id="d1547e157" rowspan="1">
    Description
   </th>
   <th class="documents-cell-norowborder" colspan="1" id="d1547e160" rowspan="1">
    Reset
   </th>
  </tr>
 </thead>
 <tbody>
  ...
  <tr>
   ...
   <td class="documents-cell-norowborder" colspan="1" id="mhus_pbx_pbx_feat_spt0__id-19-16-reset-2" rowspan="1">
  ...
  <tr>
   ...
   <td class="documents-cell-norowborder" colspan="1" id="mhus_pbx_pbx_feat_spt0__id-15-12-reset-2" rowspan="1">
    The reset values can be the following:
    <span class="documents-g.number.bin">
     0b0000
    </span>
  ...
  <tr>
   ...
   <td class="documents-cell-norowborder" colspan="1" id="mhus_pbx_pbx_feat_spt0__id-11-8-reset-1" rowspan="1">
    The reset values can be the following:
    <span class="documents-g.number.bin">
     0b0000
    </span>
  ...
  <tr>
   ...
   <td class="documents-cell-norowborder" colspan="1" id="mhus_pbx_pbx_feat_spt0__id-7-4-reset-7" rowspan="1">
    The reset values can be the following:
    <span class="documents-g.number.bin">
     0b0000
    </span>
  ...
  <tr>
   ...
   <td class="documents-cellrowborder" colspan="1" id="mhus_pbx_pbx_feat_spt0__id-3-0-reset-9" rowspan="1">
    The reset values can be the following:
    <span class="documents-g.number.bin">
     0b0000
    </span>
...
<table>
 ...
 <thead>
  <tr>
   <th class="documents-nocellnorowborder" colspan="1" id="d1547e492" rowspan="1">
    Component
   </th>
   <th class="documents-nocellnorowborder" colspan="1" id="d1547e495" rowspan="1">
    Offset
   </th>
   <th class="documents-nocellnorowborder" colspan="1" id="d1547e498" rowspan="1">
    Instance
   </th>
   <th class="documents-cell-norowborder" colspan="1" id="d1547e501" rowspan="1">
    Range
   </th>
  </tr>
 </thead>
