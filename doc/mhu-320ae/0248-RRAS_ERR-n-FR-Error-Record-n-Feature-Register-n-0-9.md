# RRAS_ERR<n>FR, Error Record <n> Feature Register, n = 0 - 9

Source: <https://developer.arm.com/documentation/107612/0001/Programmers-model-for-MHU-320AE/MHU-Receiver-registers/MHU-Receiver-RAS-register-summary/RRAS-ERR-n-FR--Error-Record--n--Feature-Register--n---0---9>

### RRAS\_ERR<n>FR, Error Record <n> Feature Register, n = 0 - 9
...
Figure 1. MHUR\_RRAS\_ERR<n>FR bit assignments

![mhur_rras_err_n_fr bit assignments](images/0248-RRAS_ERR-n-FR-Error-Record-n-Feature-Register-n-0-9-img01.svg)

<table id="mhur_rras_err_n_fr__arras_errnfr-0">
 <caption>
  <span class="documents-tablecap">
   <span class="documents-table--title-label">
    Table 1.
   </span>
   RRAS_ERR&lt;n&gt;FR bit descriptions
  </span>
 </caption>
 <colgroup>
  <col span="1"/>
 ...
 <thead>
  <tr>
   <th class="documents-nocellnorowborder" colspan="1" id="d117159e151" rowspan="1">
    Bits
   </th>
   <th class="documents-nocellnorowborder" colspan="1" id="d117159e154" rowspan="1">
    Name
   </th>
   <th class="documents-nocellnorowborder" colspan="1" id="d117159e157" rowspan="1">
    Description
   </th>
   <th class="documents-cell-norowborder" colspan="1" id="d117159e160" rowspan="1">
    Reset
   </th>
  </tr>
 </thead>
 <tbody>
  ...
  <tr>
   ...
   <td class="documents-nocellnorowborder" colspan="1" rowspan="1">
    ...
    <dl>
     ...
     <dd>
      <p>
       Records only non-specific Corrected errors. That is, Corrected errors recorded by setting RRAS_ERR&lt;n&gt;STATUS.CE to 0b10.
      </p>
     </dd>
    </dl>
   </td>
   <td class="documents-cell-norowborder" colspan="1" rowspan="1">
    <span id="mhur_rras_err_n_fr__bits-54-53-reset">
     xx
    </span>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td class="documents-cell-norowborder" colspan="1" rowspan="1">
    <span id="mhur_rras_err_n_fr__bits-51-reset">
     x
    </span>
   </td>
  </tr>
  <tr>
   ...
   <td class="documents-cell-norowborder" colspan="1" rowspan="1">
    <span id="mhur_rras_err_n_fr__bits-50-reset">
     x
    </span>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td class="documents-nocellnorowborder" colspan="1" rowspan="1">
    <p>
     Feature Register extension. Defines whether RRAS_ERR&lt;n&gt;FR[63:48] are architecturally defined.
    </p>
    <dl>
     <dt class="documents-dlterm">
      <span class="documents-g.number.bin">
     ...
     <dd>
      <p>
       RRAS_ERR&lt;n&gt;FR[63:48] are defined by the architecture.
      </p>
     </dd>
    </dl>
   </td>
  ...
  <tr>
   ...
   <td class="documents-nocellnorowborder" colspan="1" rowspan="1">
    ...
    <dl>
     ...
     <dd>
      <p>
       Enabling and disabling of error counter(s) is supported and controlled by RRAS_ERR&lt;n&gt;CTLR.CED.
      </p>
     </dd>
    </dl>
   </td>
   <td class="documents-cell-norowborder" colspan="1" rowspan="1">
    <span id="mhur_rras_err_n_fr__bits-30-reset-1">
     x
    </span>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td class="documents-nocellnorowborder" colspan="1" rowspan="1">
    ...
    <dl>
     ...
     <dd>
      <p>
       Does not support the critical error interrupt. RRAS_ERR&lt;n&gt;CTLR.CI is
       <span class="documents-archterm">
        RES0
       </span>
       .
  ...
  <tr>
   ...
   <td class="documents-nocellnorowborder" colspan="1" rowspan="1">
    ...
    <dl>
     ...
     <dd>
      <p>
       Does not support the enabling and disabling of error recovery interrupts on deferred errors. RRAS_ERR&lt;n&gt;CTLR.DUI is
       <span class="documents-archterm">
        RES0
       </span>
       .
  ...
  <tr>
   ...
   <td class="documents-nocellnorowborder" colspan="1" rowspan="1">
    <p>
     Repeat counter. Indicates whether the node implements a second Corrected error counter in RRAS_ERR&lt;n&gt;MISC0.
    </p>
    <dl>
     <dt class="documents-dlterm">
      <span class="documents-g.number.bin">
     ...
     <dd>
      <p>
       Implements a single Corrected error counter in RRAS_ERR&lt;n&gt;MISC0
      </p>
     </dd>
    </dl>
   </td>
  ...
  <tr>
   ...
   <td class="documents-nocellnorowborder" colspan="1" rowspan="1">
    <p>
     Corrected Error Counter. Indicates whether the node implements the standard Corrected error counter mechanisms in RRAS_ERR&lt;n&gt;MISC0.
    </p>
    <dl>
     <dt class="documents-dlterm">
      <span class="documents-g.number.bin">
     ...
     <dd>
      <p>
       Implements an 8-bit Corrected error counter in RRAS_ERR&lt;n&gt;MISC0[39:32].
      </p>
     </dd>
    </dl>
   </td>
   <td class="documents-cell-norowborder" colspan="1" rowspan="1">
    <span id="mhur_rras_err_n_fr__bits-14-12-reset">
     xxx
    </span>
   </td>
  </tr>
  <tr>
   ...
   <td class="documents-nocellnorowborder" colspan="1" rowspan="1">
    ...
    <dl>
     ...
     <dd>
      <p>
       Does not support the enabling and disabling of fault handling interrupts on corrected errors. RRAS_ERR&lt;n&gt;CTLR.CFI is
       <span class="documents-archterm">
        RES0
       </span>
       .
  ...
  <tr>
   ...
   <td class="documents-nocellnorowborder" colspan="1" rowspan="1">
    ...
    <dl>
     ...
     <dd>
      <p>
       In-band error response is supported and controllable using RRAS_ERR&lt;n&gt;CTLR.UE.
      </p>
     </dd>
    </dl>
   </td>
   <td class="documents-cell-norowborder" colspan="1" rowspan="1">
    <span id="mhur_rras_err_n_fr__bits-9-8-reset">
     xx
    </span>
   </td>
  </tr>
  <tr>
   ...
   <td class="documents-nocellnorowborder" colspan="1" rowspan="1">
    ...
    <dl>
     ...
     <dd>
      <p>
       Fault handling interrupt is supported and controllable using RRAS_ERR&lt;n&gt;CTLR.FI.
      </p>
     </dd>
    </dl>
   </td>
  ...
  <tr>
   ...
   <td class="documents-nocellnorowborder" colspan="1" rowspan="1">
    ...
    <dl>
     ...
     <dd>
      <p>
       Does not support the error handling interrupt. RRAS_ERR&lt;n&gt;CTLR.UI is
       <span class="documents-archterm">
        RES0
       </span>
       .
     ...
     <dd>
      <p>
       Error handling interrupt is supported and controllable using RRAS_ERR&lt;n&gt;CTLR.UI.
      </p>
     </dd>
    </dl>
   </td>
   <td class="documents-cell-norowborder" colspan="1" rowspan="1">
    <span id="mhur_rras_err_n_fr__bits-5-4-reset">
     xx
    </span>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td class="documents-row-nocellborder" colspan="1" rowspan="1">
    ...
    <dl>
     ...
     <dd>
      <p>
       Error reporting and logging always enabled. RRAS_ERR&lt;n&gt;CTLR.ED is
       <span class="documents-archterm">
        RES0
       </span>
       .
...
<table>
 ...
 <thead>
  <tr>
   <th class="documents-nocellnorowborder" colspan="1" id="d117159e1184" rowspan="1">
    Component
   </th>
   <th class="documents-nocellnorowborder" colspan="1" id="d117159e1187" rowspan="1">
    Offset
   </th>
   <th class="documents-nocellnorowborder" colspan="1" id="d117159e1190" rowspan="1">
    Instance
   </th>
   <th class="documents-cell-norowborder" colspan="1" id="d117159e1193" rowspan="1">
    Range
   </th>
  </tr>
 </thead>
