# Mapping for address target groups to CHI bus requester ports

Source: <https://developer.arm.com/documentation/107721/0001/CHI-requester-interface/Configure-CHI-bus-requester-ports-to-use-address-target-groups/Mapping-for-address-target-groups-to-CHI-bus-requester-ports>
...
<table id="kft1660577264504__table_mp_mapping">
 <caption>
 ...
 <thead>
  <tr>
   <th class="documents-cellrowborder" colspan="1" id="d130208e106" rowspan="1">
    Number of bus
    <span class="documents-keyword">
     requester
    </span>
   ...
   <th class="documents-cellrowborder" colspan="1" id="d130208e112" rowspan="1">
    <span>
     <span class="documents-keyword">
      REQUESTER
     </span>
   ...
   <th class="documents-cellrowborder" colspan="1" id="d130208e118" rowspan="1">
    <span>
     <span class="documents-keyword">
