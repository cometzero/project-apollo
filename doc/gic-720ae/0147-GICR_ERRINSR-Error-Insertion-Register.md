# GICR_ERRINSR, Error Insertion Register

Source: <https://developer.arm.com/documentation/102666/0201/Programmers-model-for-GIC-720AE/Redistributor-registers-for-SGIs-and-PPIs-summary/GICR-ERRINSR--Error-Insertion-Register>

### GICR\_ERRINSR, Error Insertion Register

This register can inject errors into the PPI RAM. You can use this register to test your error recovery software.

### Configurations

This register is available in configurations where the GIC Cluster Interface (GCI) supports ECC. See [Limitations](https://developer.arm.com/documentation/102666/0201/Getting-started-with-GIC-720AE/Removing-cores-from-a-preconfigured-GIC?lang=en#dsb1505904597662__section.limitations) for information about situations where the GICRn\_ERRINSR register is not present.
...
<table>
<caption>
<span class="documents-tablecap"><span class="documents-table--title-label">Table 1. </span>GICR_ERRINSR bit assignments for writes</span>
</caption>
<colgroup>
<col span="1"/>
<col span="1"/>
...
<thead>
<tr>
<th class="documents-nocellnorowborder" colspan="1" id="d156728e140" rowspan="1">Bits</th>
<th class="documents-nocellnorowborder" colspan="1" id="d156728e143" rowspan="1">Name</th>
<th class="documents-cell-norowborder" colspan="1" id="d156728e146" rowspan="1">Description</th>
</tr>
</thead>
<tbody>
<tr>
...
<table>
<caption>
<span class="documents-tablecap"><span class="documents-table--title-label">Table 2. </span>GICR_ERRINSR bit assignments for reads</span>
</caption>
<colgroup>
<col span="1"/>
<col span="1"/>
...
<thead>
<tr>
<th class="documents-nocellnorowborder" colspan="1" id="d156728e371" rowspan="1">Bits</th>
<th class="documents-nocellnorowborder" colspan="1" id="d156728e374" rowspan="1">Name</th>
<th class="documents-cell-norowborder" colspan="1" id="d156728e377" rowspan="1">Description</th>
</tr>
</thead>
<tbody>
<tr>
...
<td class="documents-cell-norowborder" colspan="1" rowspan="1">Indicates if the error injection process was successful, and the value is valid only when Valid == 0:
