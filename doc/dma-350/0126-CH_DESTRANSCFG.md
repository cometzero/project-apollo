...
Source: <https://developer.arm.com/documentation/102482/0000/Programmers-model/Register-descriptions/DMACH-n--description/CH-DESTRANSCFG>
...
<table>
 <caption>
  <span class="documents-tablecap">
   ...
   CH_DESTRANSCFG register bit descriptions
  </span>
 </caption>
 <colgroup>
  <col span="1"/>
 ...
 <thead>
  <tr>
   <th class="documents-nocellnorowborder" colspan="1" id="d58493e129" rowspan="1">
    <p>
     Bits
    </p>
   </th>
   <th class="documents-nocellnorowborder" colspan="1" id="d58493e133" rowspan="1">
    <p>
     Name
    </p>
   </th>
   <th class="documents-nocellnorowborder" colspan="1" id="d58493e137" rowspan="1">
    <p>
     Description
    </p>
   </th>
   <th class="documents-nocellnorowborder" colspan="1" id="d58493e141" rowspan="1">
    <p>
     Type
    </p>
   </th>
   <th class="documents-cell-norowborder" colspan="1" id="d58493e145" rowspan="1">
    <p>
     Default
    </p>
   </th>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td class="documents-row-nocellborder" colspan="1" rowspan="1">
    <p>
     Destination Transfer Memory Attribute field [3:0].
    </p>
    <p>
