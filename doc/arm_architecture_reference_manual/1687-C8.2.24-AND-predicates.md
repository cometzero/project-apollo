...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-24-AND--predicates->
...
This instruction is used by the alias [MOV (predicate, zeroing)](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-460-MOV--predicate--zeroing-?lang=en#isa_mov_and_p_p_pp).

###### Not setting the condition flags

###### (FEAT\_SVE || FEAT\_SME)

![](images/1687-C8.2.24-AND-predicates-img01.svg)
