...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-792-TBLQ>
...
![](images/2455-C8.2.792-TBLQ-img01.svg)
...
        else
            result[(s * elements + e)*:esize] = Zeros{esize};
        end;
    end;
end;
Z{VL}(d) = result;
