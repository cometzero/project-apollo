...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-161-FAMAX>

##### C8.2.161 FAMAX

Floating-point absolute maximum (predicated)

This instruction determines the maximum absolute value from active floating-point elements of the first source vector and the corresponding floating-point elements of the second source vector, and destructively places the results in the corresponding elements of the first source vector.
...
![](images/1824-C8.2.161-FAMAX-img01.svg)
...
        result[e*:esize] = FPAbsMax{esize}(element1, element2, FPCR());
    else
