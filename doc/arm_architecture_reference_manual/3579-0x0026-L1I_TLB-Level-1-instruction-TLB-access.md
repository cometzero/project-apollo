...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-3-Common-event-numbers/-0x0026--L1I-TLB--Level-1-instruction-TLB-access>

##### `0x0026`, L1I\_TLB, Level 1 instruction TLB access

The counter counts each [Instruction memory access](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-1-Definitions/-D14-1-1-Definition-of-terms?lang=en#cachjjbe) that causes a TLB access to at least the Level 1 instruction TLB.
