# ​C6.2.236 LDSMAXB, LDSMAXAB, LDSMAXALB, LDSMAXLB

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-236-LDSMAXB--LDSMAXAB--LDSMAXALB--LDSMAXLB>
...
This instruction is used by the alias [STSMAXB, STSMAXLB](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-426-STSMAXB--STSMAXLB?lang=en#isa_stsmaxb_ldsmaxb).

###### Integer

###### (FEAT\_LSE)

![](images/0918-C6.2.236-LDSMAXB-LDSMAXAB-LDSMAXALB-LDSMAXLB-img01.svg)
...
let value : bits(8) = X{8}(s);
let data : bits(8) = MemAtomic{}(address, comparevalue, value, accdesc);
if t != 31 then
