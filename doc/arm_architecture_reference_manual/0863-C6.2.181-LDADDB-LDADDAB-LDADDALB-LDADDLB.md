# ​C6.2.181 LDADDB, LDADDAB, LDADDALB, LDADDLB

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-181-LDADDB--LDADDAB--LDADDALB--LDADDLB>
...
This instruction is used by the alias [STADDB, STADDLB](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-387-STADDB--STADDLB?lang=en#isa_staddb_ldaddb).

###### Integer

###### (FEAT\_LSE)

![](images/0863-C6.2.181-LDADDB-LDADDAB-LDADDALB-LDADDLB-img01.svg)
