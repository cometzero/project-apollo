...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-245-VSTR>
...
It has encodings from the following instruction sets: A32 ([A1](/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-245-VSTR?lang=en#isa_vstr_iclass_a1)) and T32 ([T1](/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-245-VSTR?lang=en#isa_vstr_iclass_t1)).

###### A1

![](images/6171-F6.1.245-VSTR-img01.svg)
...
if n == 15 && CurrentInstrSet() != InstrSet_A32 then UnpredictableProcedure(); end;
```
...
![](images/6171-F6.1.245-VSTR-img02.svg)
...
                MemA{32}(address)   = D(d)[63:32];
                MemA{32}(address+4) = D(d)[31:0];
            else
                MemA{32}(address)   = D(d)[31:0];
                MemA{32}(address+4) = D(d)[63:32];
            end;
    end;
end;
```
