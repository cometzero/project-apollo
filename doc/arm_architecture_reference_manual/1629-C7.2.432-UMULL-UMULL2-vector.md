...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-432-UMULL--UMULL2--vector->
...
![](images/1629-C7.2.432-UMULL-UMULL2-vector-img01.svg)
...
    result[e*:(2*esize)] = (element1 * element2)[2*esize-1:0];
end;
