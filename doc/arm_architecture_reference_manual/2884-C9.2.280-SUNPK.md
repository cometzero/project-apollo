...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-280-SUNPK>

##### C9.2.280 SUNPK

Unpack and sign-extend multi-vector elements

This instruction unpacks and sign-extends elements from one or two source vectors, and writes the sign-extended values into the double-width elements of two or four destination vectors. This instruction is unpredicated.

It has encodings from 2 classes: [Two registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-280-SUNPK?lang=en#isa_sunpk_mz_z_iclass_two_registers) and [Four registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-280-SUNPK?lang=en#isa_sunpk_mz_z_iclass_four_registers)

###### Two registers

###### (FEAT\_SME2)

![](images/2884-C9.2.280-SUNPK-img01.svg)
...
![](images/2884-C9.2.280-SUNPK-img02.svg)
