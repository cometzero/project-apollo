# ​D24.2.211 TTBR1_EL1, Translation Table Base Register 1 (EL1)

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-2-General-system-control-registers/-D24-2-211-TTBR1-EL1--Translation-Table-Base-Register-1--EL1->

##### D24.2.211 TTBR1\_EL1, Translation Table Base Register 1 (EL1)
...
:   TTBR1\_EL1 is a 128-bit register that can also be accessed as a 64-bit value. If it is accessed as a 64-bit register, accesses read and write bits [63:0] and do not modify bits [127:64].
    ...
    AArch64 System register TTBR1\_EL1 bits [63:0] are architecturally mapped to AArch32 System register [TTBR1](/documentation/ddi0487/mc/-Part-G-The-AArch32-System-Level-Architecture/-Chapter-G8-AArch32-System-Register-Descriptions/-G8-2-General-system-control-registers/-G8-2-168-TTBR1--Translation-Table-Base-Register-1?lang=en#reg_aarch32_ttbr1)[63:0].
...
:   ![](images/5103-D24.2.211-TTBR1_EL1-Translation-Table-Base-Register-1-EL1-img01.svg)
...
:   Skip Level associated with translation table walks using TTBR1\_EL1.
    ...
    This determines the number of levels to be skipped from the regular start level of the stage 1 EL1&0 translation table walks using [TTBR1\_EL1](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-2-General-system-control-registers/-D24-2-211-TTBR1-EL1--Translation-Table-Base-Register-1--EL1-?lang=en#reg_aarch64_ttbr1_el1).
...
:   ![](images/5103-D24.2.211-TTBR1_EL1-Translation-Table-Base-Register-1-EL1-img02.svg)
...
:   Translation table base address:
    ...
    Address bit x is the minimum address bit required to align the translation table to the size of the table. The AArch64 Virtual Memory System Architecture chapter describes how x is calculated based on the value of [TCR\_EL1](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-2-General-system-control-registers/-D24-2-193-TCR-EL1--Translation-Control-Register--EL1-?lang=en#reg_aarch64_tcr_el1).T1SZ, the translation stage, and the translation granule size.
...
`When FEAT_VHE is implemented MRS <Xt>, TTBR1_EL12`
:
...
`When FEAT_VHE is implemented MSR TTBR1_EL12, <Xt>`
:
...
`When FEAT_D128 is implemented and FEAT_VHE is implemented MRRS <Xt>, <Xt+1>, TTBR1_EL12`
:
...
`When FEAT_D128 is implemented and FEAT_VHE is implemented MSRR TTBR1_EL12, <Xt>, <Xt+1>`
:
