...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-383-STL1--SIMD-FP->
...
![](images/1580-C7.2.383-STL1-SIMDandFP-img01.svg)
...
let accdesc : AccessDescriptor = CreateAccDescASIMDAcqRel(MemOp_STORE, tagchecked);
if n == 31 then
    CheckSPAlignment();
    address = SP{64}();
else
