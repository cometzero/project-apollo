...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-22-BIC--vector--register->
...
![](images/1219-C7.2.22-BIC-vector-register-img01.svg)
...
V{datasize}(d) = operand1 AND operand2;
```
