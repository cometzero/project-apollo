...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-269-FSQRT>
...
It has encodings from 2 classes: [Merging](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-269-FSQRT?lang=en#isa_fsqrt_z_p_z_iclass_merging) and [Zeroing](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-269-FSQRT?lang=en#isa_fsqrt_z_p_z_iclass_zeroing)

###### Merging

###### (FEAT\_SVE || FEAT\_SME)

![](images/1932-C8.2.269-FSQRT-img01.svg)
...
![](images/1932-C8.2.269-FSQRT-img02.svg)

###### Encoding

```
FSQRT  <Zd>.<T>, <Pg>/Z, <Zn>.<T>
```
