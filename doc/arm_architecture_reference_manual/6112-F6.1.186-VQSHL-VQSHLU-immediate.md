...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-186-VQSHL--VQSHLU--immediate->
...
It has encodings from the following instruction sets: A32 ([A1](/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-186-VQSHL--VQSHLU--immediate-?lang=en#isa_vqshl_i_iclass_a1)) and T32 ([T1](/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-186-VQSHL--VQSHLU--immediate-?lang=en#isa_vqshl_i_iclass_t1)).

###### A1

![](images/6112-F6.1.186-VQSHL-VQSHLU-immediate-img01.svg)
...
Applies when `(op == 1 && Q == 1 && !(imm6[5:3] == 000 && L == 0))`
...
![](images/6112-F6.1.186-VQSHL-VQSHLU-immediate-img02.svg)
...
:   ​
    ...
    For the “A1 128-bit SIMD vector, signed result”, “A1 128-bit SIMD vector, unsigned result”, “A1 64-bit SIMD vector, signed result”, and “A1 64-bit SIMD vector, unsigned result” variants: see [Standard assembler syntax fields](/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F1-About-the-T32-and-A32-Instruction-Descriptions/-F1-2-Standard-assembler-syntax-fields?lang=en#babbefhf). This encoding must be unconditional.

    ​

    For the “T1 128-bit SIMD vector, signed result”, “T1 128-bit SIMD vector, unsigned result”, “T1 64-bit SIMD vector, signed result”, and “T1 64-bit SIMD vector, unsigned result” variants: see [Standard assembler syntax fields](/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F1-About-the-T32-and-A32-Instruction-Descriptions/-F1-2-Standard-assembler-syntax-fields?lang=en#babbefhf).
