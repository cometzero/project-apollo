...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-208-SMLAL--multiple-and-indexed-vector->

##### C9.2.208 SMLAL (multiple and indexed vector)

Multi-vector signed 16-bit integer multiply-add by indexed element to 32-bit integer

This instruction multiplies each signed 16-bit element in the one, two, or four first source vectors by each signed 16-bit indexed element of the second source vector, widens each product to 32 bits, and destructively adds these values to the corresponding 32-bit elements of the ZA double-vector groups.
...
It has encodings from 3 classes: [One ZA double-vector](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-208-SMLAL--multiple-and-indexed-vector-?lang=en#isa_smlal_za_zzi_iclass_one_za_double_vector), [Two ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-208-SMLAL--multiple-and-indexed-vector-?lang=en#isa_smlal_za_zzi_iclass_two_za_double_vectors), and [Four ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-208-SMLAL--multiple-and-indexed-vector-?lang=en#isa_smlal_za_zzi_iclass_four_za_double_vectors)

###### One ZA double-vector

###### (FEAT\_SME2)

![](images/2812-C9.2.208-SMLAL-multiple-and-indexed-vector-img01.svg)
...
![](images/2812-C9.2.208-SMLAL-multiple-and-indexed-vector-img02.svg)
...
![](images/2812-C9.2.208-SMLAL-multiple-and-indexed-vector-img03.svg)

###### Encoding

```
SMLAL  ZA.S[<Wv>, <offs1>:<offs2>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H[<index>]
```
...
            let element2 : integer = SInt(operand2[s*:(esize DIV 2)]);
