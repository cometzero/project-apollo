...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-340-UVDOT--2-way->
...
![](images/2944-C9.2.340-UVDOT-2-way-img01.svg)
...
            let element1 : integer = UInt(operand1[(2 * e + r)*:(esize DIV 2)]);
