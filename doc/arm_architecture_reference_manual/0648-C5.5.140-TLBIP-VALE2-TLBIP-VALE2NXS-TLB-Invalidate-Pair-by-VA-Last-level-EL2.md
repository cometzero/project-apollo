...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-140-TLBIP-VALE2--TLBIP-VALE2NXS--TLB-Invalidate-Pair-by-VA--Last-level--EL2>
...
Configuration
:   This system instruction is present only when FEAT\_D128 is implemented and FEAT\_AA64 is implemented. Otherwise, direct accesses to TLBIP VALE2, TLBIP VALE2NXS are UNDEFINED.
...
![](images/0648-C5.5.140-TLBIP-VALE2-TLBIP-VALE2NXS-TLB-Invalidate-Pair-by-VA-Last-level-EL2-img01.svg)
...
if !(IsFeatureImplemented(FEAT_D128) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    AArch64_TLBIP_VA(SecurityStateAtEL(EL2), Regime_EL2, VMID_NONE, Broadcast_NSH, TLBILevel_Last, TLBI_ExcludeXS, X{128}(t, t2));
elsif PSTATE.EL == EL3 then
    if !EL2Enabled() then
        Undefined();
    else
