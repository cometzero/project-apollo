...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-33-TLBI-RVAALE1IS--TLBI-RVAALE1ISNXS--TLB-Range-Invalidate-by-VA--All-ASID--Last-Level--EL1--Inner-Shareable>
...
:   Invalidates cached copies of translation table entries from TLBs that meet all the following requirements:
    ...
    - The entry is one of the following:
      ...
      - A 64-bit stage 1 translation table entry, from the leaf level of the translation table walk, to the level indicated by the TTL hint.
...
Configuration
:   This system instruction is present only when FEAT\_TLBIRANGE is implemented and FEAT\_AA64 is implemented. Otherwise, direct accesses to TLBI RVAALE1IS, TLBI RVAALE1ISNXS are UNDEFINED.
...
![](images/0541-C5.5.33-TLBI-RVAALE1IS-TLBI-RVAALE1ISNXS-TLB-Range-Invalidate-by-VA-All-ASID-Last-Level-EL1-Inner-Shareable-img01.svg)
...
if !(IsFeatureImplemented(FEAT_TLBIRANGE) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    elsif EL2Enabled() && IsFeatureImplemented(FEAT_FGT) && (!HaveEL(EL3) || SCR_EL3().FGTEn == '1') && HFGITR_EL2().TLBIRVAALE1IS == '1' then
        AArch64_SystemAccessTrap(EL2, 0x18);
    else
...
`When FEAT_XS is implemented TLBI RVAALE1ISNXS{, <Xt>}`
:
  ...
  <tr>
   ...
   <td>
    ...
    if !(IsFeatureImplemented(FEAT_TLBIRANGE) && IsFeatureImplemented(FEAT_AA64)) then
        ...
        if EL2Enabled() && (HCR_EL2().TTLB == '1' || HCR_EL2().TTLBIS == '1') then
            AArch64_SystemAccessTrap(EL2, 0x18);
        elsif EL2Enabled() && IsFeatureImplemented(FEAT_FGT) && (!HaveEL(EL3) || SCR_EL3().FGTEn == '1') && IsFeatureImplemented(FEAT_HCX) && (!IsHCRXEL2Enabled() || HCRX_EL2().FGTnXS == '0') && HFGITR_EL2().TLBIRVAALE1IS == '1' then
            AArch64_SystemAccessTrap(EL2, 0x18);
        else
            AArch64_TLBI_RVAA(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_ISH, TLBILevel_Last, TLBI_ExcludeXS, X{64}(t));
        end;
    elsif PSTATE.EL == EL2 then
        AArch64_TLBI_RVAA(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_ISH, TLBILevel_Last, TLBI_ExcludeXS, X{64}(t));
    elsif PSTATE.EL == EL3 then
