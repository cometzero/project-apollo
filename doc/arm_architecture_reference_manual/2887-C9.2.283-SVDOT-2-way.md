...
![](images/2887-C9.2.283-SVDOT-2-way-img01.svg)
...
            let element1 : integer = SInt(operand1[(2 * e + r)*:(esize DIV 2)]);
