...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-114-CNT>

##### C8.2.114 CNT

Count nonzero bits (predicated)

This instruction determines the number of nonzero bits in each active element of the source vector, and places the results in the corresponding elements of the destination vector. Inactive elements in the destination vector register remain unmodified or are set to zero, depending on whether merging or zeroing predication is selected.

It has encodings from 2 classes: [Merging](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-114-CNT?lang=en#isa_cnt_z_p_z_iclass_merging) and [Zeroing](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-114-CNT?lang=en#isa_cnt_z_p_z_iclass_zeroing)

###### Merging

###### (FEAT\_SVE || FEAT\_SME)

![](images/1777-C8.2.114-CNT-img01.svg)
...
![](images/1777-C8.2.114-CNT-img02.svg)
...
        result[e*:esize] = BitCount(element)[esize-1:0];
    end;
end;
Z{VL}(d) = result;
```
