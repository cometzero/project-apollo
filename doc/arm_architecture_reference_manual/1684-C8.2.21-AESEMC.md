...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-21-AESEMC>
...
![](images/1684-C8.2.21-AESEMC-img02.svg)

###### Encoding

```
AESEMC  { <Zdn1>.B-<Zdn4>.B }, { <Zdn1>.B-<Zdn4>.B }, <Zm>.Q[<index>]
```
...
        results[[r]][s*:128] = AESMixColumns(AESSubBytes(AESShiftRows(res)));
    end;
end;
for r = 0 to nreg-1 do
    Z{VL}(dn + r) = results[[r]];
