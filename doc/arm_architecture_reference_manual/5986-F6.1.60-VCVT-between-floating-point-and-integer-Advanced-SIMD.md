...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-60-VCVT--between-floating-point-and-integer--Advanced-SIMD->
...
It has encodings from the following instruction sets: A32 ([A1](/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-60-VCVT--between-floating-point-and-integer--Advanced-SIMD-?lang=en#isa_vcvt_is_iclass_a1)) and T32 ([T1](/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-60-VCVT--between-floating-point-and-integer--Advanced-SIMD-?lang=en#isa_vcvt_is_iclass_t1)).

###### A1

![](images/5986-F6.1.60-VCVT-between-floating-point-and-integer-Advanced-SIMD-img01.svg)
...
let to_integer : boolean = (op[1] == ‘1’);
let unsigned : boolean = (op[0] == ‘1’);
...
![](images/5986-F6.1.60-VCVT-between-floating-point-and-integer-Advanced-SIMD-img02.svg)
...
            if to_integer then
                result = FPToFixed{esize, esize}(operand1, 0, unsigned, fpcr, FPRounding_ZERO);
            else
                result = FixedToFP{esize, esize}(operand1, 0, unsigned, fpcr, FPRounding_TIEEVEN);
            end;
