# ​D24.5.42 SPMEVTYPER<n>_EL0, System Performance Monitors Event Type Register, n = 0 - 63

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-5-Performance-Monitors-registers/-D24-5-42-SPMEVTYPER-n--EL0--System-Performance-Monitors-Event-Type-Register--n---0---63>
...
![](images/5268-D24.5.42-SPMEVTYPER-n-_EL0-System-Performance-Monitors-Event-Type-Register-n-0-63-img01.svg)
...
if !(IsFeatureImplemented(FEAT_SPMU) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    if MDSCR_EL1().EnSPM == '0' then
        ...
        SPMEVTYPER_EL0(UInt(SPMSELR_EL0().SYSPMUSEL), (UInt(SPMSELR_EL0().BANK) * 16) + m) = X{64}(t);
    end;
elsif PSTATE.EL == EL1 then
