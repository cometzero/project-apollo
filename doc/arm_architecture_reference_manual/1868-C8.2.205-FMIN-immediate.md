...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-205-FMIN--immediate->
...
![](images/1868-C8.2.205-FMIN-immediate-img01.svg)
...
        result[e*:esize] = FPMin{esize}(element1, imm, FPCR());
    else
