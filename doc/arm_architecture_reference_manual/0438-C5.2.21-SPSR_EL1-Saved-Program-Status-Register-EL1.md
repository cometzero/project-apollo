# ​C5.2.21 SPSR_EL1, Saved Program Status Register (EL1)

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-2-Special-purpose-registers/-C5-2-21-SPSR-EL1--Saved-Program-Status-Register--EL1->

##### C5.2.21 SPSR\_EL1, Saved Program Status Register (EL1)
...
:   This register is a Special-purpose register.
    ...
    AArch64 System register SPSR\_EL1 bits [31:0] are architecturally mapped to AArch32 System register [SPSR\_svc](/documentation/ddi0487/mc/-Part-G-The-AArch32-System-Level-Architecture/-Chapter-G8-AArch32-System-Register-Descriptions/-G8-2-General-system-control-registers/-G8-2-134-SPSR-svc--Saved-Program-Status-Register--Supervisor-mode-?lang=en#reg_aarch32_spsr_svc)[31:0].
...
:   ![](images/0438-C5.2.21-SPSR_EL1-Saved-Program-Status-Register-EL1-img01.svg)
...
M[4], bit [4]
:   Execution state. Set to 1, the value of PSTATE.nRW, on taking an exception to EL1 from AArch32 state, and copied to PSTATE.nRW on executing an exception return operation in EL1.
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    Other values are reserved. If SPSR\_EL1.M[3:0] has a Reserved value, or a value for an unimplemented Exception level, executing an exception return operation in EL1 is an illegal return event, as described in [‘Illegal return events from AArch64 state’](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D1-The-AArch64-System-Level-Programmers--Model/-D1-4-Exceptions/-D1-4-4-Exception-return?lang=en#mdsec_illegal_exception_returns_from_aarch64_state).
...
:   ![](images/0438-C5.2.21-SPSR_EL1-Saved-Program-Status-Register-EL1-img02.svg)
...
M[4], bit [4]
:   Execution state. Set to 0, the value of PSTATE.nRW, on taking an exception to EL1 from AArch64 state, and copied to PSTATE.nRW on executing an exception return operation in EL1.
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     EL1 with SP_EL0 (EL1t) and either
  ...
  <tr>
   ...
   <td>
    <p>
     EL1 with SP_EL1 (EL1h) and either
     <a class="document-topic" document-topic-path="/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-2-General-system-control-registers/-D24-2-61-HCR-EL2--Hypervisor-Configuration-Register?lang=en#reg_aarch64_hcr_el2" href="/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-2-General-system-control-registers/-D24-2-61-HCR-EL2--Hypervisor-Configuration-Register?lang=en#reg_aarch64_hcr_el2">
      HCR_EL2
     </a>
     .{NV, NV1} is {1,0} or
    ...
    - M[3:2]: On an exception to EL1:
      ...
      - If the exception is taken from EL1:
        - If the Effective value of [HCR\_EL2](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-2-General-system-control-registers/-D24-2-61-HCR-EL2--Hypervisor-Configuration-Register?lang=en#reg_aarch64_hcr_el2).{NV, NV1} is not {1,0} and the Effective value of [HCR\_EL2](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-2-General-system-control-registers/-D24-2-61-HCR-EL2--Hypervisor-Configuration-Register?lang=en#reg_aarch64_hcr_el2).{NV, NV2} is not {1,1}, then M[3:2] is set to the value of PSTATE.EL on taking an exception to EL1.
        - If the Effective value of [HCR\_EL2](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-2-General-system-control-registers/-D24-2-61-HCR-EL2--Hypervisor-Configuration-Register?lang=en#reg_aarch64_hcr_el2).{NV, NV1} is {1,0} or if the Effective value of [HCR\_EL2](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-2-General-system-control-registers/-D24-2-61-HCR-EL2--Hypervisor-Configuration-Register?lang=en#reg_aarch64_hcr_el2).{NV, NV2} is {1,1}, then M[3:2] is set to `0b10`.
...
`When FEAT_VHE is implemented MRS <Xt>, SPSR_EL12`
:
...
`When FEAT_VHE is implemented MSR SPSR_EL12, <Xt>`
:
...
`When FEAT_VHE is implemented MRS <Xt>, SPSR_EL2`
:
...
`When FEAT_VHE is implemented MSR SPSR_EL2, <Xt>`
:
