# ​C6.2.254 LDUMAXB, LDUMAXAB, LDUMAXALB, LDUMAXLB

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-254-LDUMAXB--LDUMAXAB--LDUMAXALB--LDUMAXLB>
...
This instruction is used by the alias [STUMAXB, STUMAXLB](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-441-STUMAXB--STUMAXLB?lang=en#isa_stumaxb_ldumaxb).

###### Integer

###### (FEAT\_LSE)

![](images/0936-C6.2.254-LDUMAXB-LDUMAXAB-LDUMAXALB-LDUMAXLB-img01.svg)
