...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-E-The-AArch32-Application-Level-Architecture/-Chapter-E2-The-AArch32-Application-Level-Memory-Model/-E2-10-Synchronization-and-semaphores/-E2-10-3-Marking-and-the-size-of-the-marked-memory-block>
...
In some implementations the CTR identifies the Exclusives reservation granule, see [CTR](/documentation/ddi0487/mc/-Part-G-The-AArch32-System-Level-Architecture/-Chapter-G8-AArch32-System-Register-Descriptions/-G8-2-General-system-control-registers/-G8-2-37-CTR--Cache-Type-Register?lang=en#reg_aarch32_ctr). Otherwise, software must assume that the maximum Exclusives reservation granule, 512 words, is implemented.
