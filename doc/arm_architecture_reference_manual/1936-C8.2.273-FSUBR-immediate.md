...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-273-FSUBR--immediate->
...
![](images/1936-C8.2.273-FSUBR-immediate-img01.svg)
...
let imm : bits(esize) = if i1 == ‘0’ then FPPointFive{esize}(‘0’) else FPOne{esize}(‘0’);
```
...
        result[e*:esize] = FPSub{esize}(imm, element1, FPCR());
    else
