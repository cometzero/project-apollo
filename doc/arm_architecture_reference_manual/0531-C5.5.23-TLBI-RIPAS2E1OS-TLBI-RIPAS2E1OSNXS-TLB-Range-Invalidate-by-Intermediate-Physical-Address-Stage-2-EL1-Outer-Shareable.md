...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-23-TLBI-RIPAS2E1OS--TLBI-RIPAS2E1OSNXS--TLB-Range-Invalidate-by-Intermediate-Physical-Address--Stage-2--EL1--Outer-Shareable>
...
:   If EL2 is implemented and enabled in the current Security state, invalidates cached copies of translation table entries from TLBs that meet all the following requirements:
    ...
    - The entry is one of the following:
      ...
      - A 64-bit stage 2 only translation table entry, from any level of the translation table walk, to the level indicated by the TTL hint.
...
![](images/0531-C5.5.23-TLBI-RIPAS2E1OS-TLBI-RIPAS2E1OSNXS-TLB-Range-Invalidate-by-Intermediate-Physical-Address-Stage-2-EL1-Outer-Shareable-img01.svg)
...
if !(IsFeatureImplemented(FEAT_TLBIRANGE) && IsFeatureImplemented(FEAT_TLBIOS) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    AArch64_TLBI_RIPAS2(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_OSH, TLBILevel_Any, TLBI_AllAttr, X{64}(t));
...
`When FEAT_XS is implemented TLBI RIPAS2E1OSNXS{, <Xt>}`
:
  ...
  <tr>
   ...
   <td>
    ...
    if !(IsFeatureImplemented(FEAT_TLBIRANGE) && IsFeatureImplemented(FEAT_TLBIOS) && IsFeatureImplemented(FEAT_AA64)) then
        ...
        AArch64_TLBI_RIPAS2(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_OSH, TLBILevel_Any, TLBI_ExcludeXS, X{64}(t));
    elsif PSTATE.EL == EL3 then
        if !EL2Enabled() then
            return;
        else
