...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-674-SQSHRNB>
...
![](images/2337-C8.2.674-SQSHRNB-img01.svg)
...
    result[(2*e + 0)*:esize] = SignedSat{esize}(res);
