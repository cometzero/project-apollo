...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-195-FMAX--immediate->
...
![](images/1858-C8.2.195-FMAX-immediate-img01.svg)
...
        result[e*:esize] = FPMax{esize}(element1, imm, FPCR());
    else
