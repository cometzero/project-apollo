# ​C6.2.239 LDSMINB, LDSMINAB, LDSMINALB, LDSMINLB

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-239-LDSMINB--LDSMINAB--LDSMINALB--LDSMINLB>
...
This instruction is used by the alias [STSMINB, STSMINLB](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-429-STSMINB--STSMINLB?lang=en#isa_stsminb_ldsminb).

###### Integer

###### (FEAT\_LSE)

![](images/0921-C6.2.239-LDSMINB-LDSMINAB-LDSMINALB-LDSMINLB-img01.svg)
...
let accdesc : AccessDescriptor = CreateAccDescAtomicOp(MemAtomicOp_SMIN, acquire, release,
