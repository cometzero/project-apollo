# ​C5.2.24 SPSR_fiq, Saved Program Status Register (FIQ mode)

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-2-Special-purpose-registers/-C5-2-24-SPSR-fiq--Saved-Program-Status-Register--FIQ-mode->

##### C5.2.24 SPSR\_fiq, Saved Program Status Register (FIQ mode)
...
:   If EL1 only supports execution in AArch64 state, this register is RES0 from EL2 and EL3.
    ...
    AArch64 System register SPSR\_fiq bits [31:0] are architecturally mapped to AArch32 System register [SPSR\_fiq](/documentation/ddi0487/mc/-Part-G-The-AArch32-System-Level-Architecture/-Chapter-G8-AArch32-System-Register-Descriptions/-G8-2-General-system-control-registers/-G8-2-130-SPSR-fiq--Saved-Program-Status-Register--FIQ-mode-?lang=en#reg_aarch32_spsr_fiq)[31:0].
...
:   ![](images/0441-C5.2.24-SPSR_fiq-Saved-Program-Status-Register-FIQ-mode-img01.svg)

Bits [63:0]
:   Reserved, RES0.

Otherwise:
:   ![](images/0441-C5.2.24-SPSR_fiq-Saved-Program-Status-Register-FIQ-mode-img02.svg)
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    Other values are reserved. If SPSR\_fiq.M[4:0] has a Reserved value, or a value for an unimplemented Exception level, executing an exception return operation in FIQ mode is an illegal return event, as described in [‘Illegal return events from AArch32 state’](/documentation/ddi0487/mc/-Part-G-The-AArch32-System-Level-Architecture/-Chapter-G1-The-AArch32-System-Level-Programmers--Model/-G1-15-Exception-return-to-an-Exception-level-using-AArch32/-G1-15-3-Illegal-return-events-from-AArch32-state?lang=en#chdddjdb).
