...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-219-FMLALB--vectors--FP16-to-FP32->
...
![](images/1882-C8.2.219-FMLALB-vectors-FP16-to-FP32-img01.svg)
...
    let elem2 : bits(esize DIV 2) = op2[(2*e + 0)*:(esize DIV 2)];
