...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-4-ADD--vectors--predicated->

##### C8.2.4 ADD (vectors, predicated)

Add (predicated)

This instruction adds active elements of the first source vector to the corresponding elements of the second source vector, and destructively places the results in the corresponding elements of the first source vector. Inactive elements in the destination vector register remain unmodified.

###### SVE

###### (FEAT\_SVE || FEAT\_SME)

![](images/1667-C8.2.4-ADD-vectors-predicated-img01.svg)
