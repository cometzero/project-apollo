...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-16-AESD--indexed->
...
It has encodings from 2 classes: [Two registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-16-AESD--indexed-?lang=en#isa_aesd_mz_zzi_iclass_two_registers) and [Four registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-16-AESD--indexed-?lang=en#isa_aesd_mz_zzi_iclass_four_registers)

###### Two registers

###### (FEAT\_SVE\_AES2)

![](images/1679-C8.2.16-AESD-indexed-img01.svg)
...
![](images/1679-C8.2.16-AESD-indexed-img02.svg)
...
        results[[r]][s*:128] = AESInvSubBytes(AESInvShiftRows(res));
    end;
end;
for r = 0 to nreg-1 do
    Z{VL}(dn + r) = results[[r]];
