...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-113-CNOT>
...
Boolean TRUE is any nonzero value in a source, and one in a result element. Boolean FALSE is always zero.

It has encodings from 2 classes: [Merging](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-113-CNOT?lang=en#isa_cnot_z_p_z_iclass_merging) and [Zeroing](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-113-CNOT?lang=en#isa_cnot_z_p_z_iclass_zeroing)

###### Merging

###### (FEAT\_SVE || FEAT\_SME)

![](images/1776-C8.2.113-CNOT-img01.svg)
...
![](images/1776-C8.2.113-CNOT-img02.svg)
...
        result[e*:esize] = ZeroExtend{esize}(IsZeroBit{esize}(element));
    end;
end;
Z{VL}(d) = result;
```
