...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-877-UQSUB--vectors--predicated->
...
![](images/2540-C8.2.877-UQSUB-vectors-predicated-img01.svg)
...
        result[e*:esize] = UnsignedSat{esize}(element1 - element2);
    else
