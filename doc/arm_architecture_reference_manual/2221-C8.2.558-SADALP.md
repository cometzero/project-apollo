...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-558-SADALP>
...
![](images/2221-C8.2.558-SADALP-img01.svg)
...
    else
        let element1 : integer = SInt(operand_src[(2*e + 0)*:(esize DIV 2)]);
        let element2 : integer = SInt(operand_src[(2*e + 1)*:(esize DIV 2)]);
