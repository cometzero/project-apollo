# ​C6.2.465 SUBS (shifted register)

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-465-SUBS--shifted-register->
...
This instruction is used by the aliases [CMP (shifted register)](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-97-CMP--shifted-register-?lang=en#isa_cmp_subs_addsub_shift) and [NEGS](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-296-NEGS?lang=en#isa_negs_subs_addsub_shift).

![](images/1147-C6.2.465-SUBS-shifted-register-img01.svg)
...
let operand2 : bits(datasize) = NOT(ShiftReg{datasize}(m, shift_type, shift_amount));
