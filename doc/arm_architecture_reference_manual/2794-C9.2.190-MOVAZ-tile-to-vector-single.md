...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-190-MOVAZ--tile-to-vector--single->
...
It has encodings from 5 classes: [8-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-190-MOVAZ--tile-to-vector--single-?lang=en#isa_movaz_z_rza_iclass_8_bit), [16-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-190-MOVAZ--tile-to-vector--single-?lang=en#isa_movaz_z_rza_iclass_16_bit), [32-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-190-MOVAZ--tile-to-vector--single-?lang=en#isa_movaz_z_rza_iclass_32_bit), [64-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-190-MOVAZ--tile-to-vector--single-?lang=en#isa_movaz_z_rza_iclass_64_bit), and [128-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-190-MOVAZ--tile-to-vector--single-?lang=en#isa_movaz_z_rza_iclass_128_bit)

###### 8-bit

###### (FEAT\_SME2p1)

![](images/2794-C9.2.190-MOVAZ-tile-to-vector-single-img01.svg)
...
![](images/2794-C9.2.190-MOVAZ-tile-to-vector-single-img02.svg)
...
![](images/2794-C9.2.190-MOVAZ-tile-to-vector-single-img03.svg)
...
![](images/2794-C9.2.190-MOVAZ-tile-to-vector-single-img04.svg)
...
![](images/2794-C9.2.190-MOVAZ-tile-to-vector-single-img05.svg)
...
ZAslice{VL}(n, esize, vertical, slice) = Zeros{VL};
Z{VL}(d) = operand;
```
