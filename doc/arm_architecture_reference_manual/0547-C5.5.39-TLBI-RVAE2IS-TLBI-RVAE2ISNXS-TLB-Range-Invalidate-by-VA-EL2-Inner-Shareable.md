...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-39-TLBI-RVAE2IS--TLBI-RVAE2ISNXS--TLB-Range-Invalidate-by-VA--EL2--Inner-Shareable>
...
:   If EL2 is implemented and enabled in the current Security state, invalidates cached copies of translation table entries from TLBs that meet all the following requirements:
    ...
    - The entry would be required to translate any VAs in the specified address range
...
Configuration
:   This system instruction is present only when FEAT\_TLBIRANGE is implemented and FEAT\_AA64 is implemented. Otherwise, direct accesses to TLBI RVAE2IS, TLBI RVAE2ISNXS are UNDEFINED.
...
![](images/0547-C5.5.39-TLBI-RVAE2IS-TLBI-RVAE2ISNXS-TLB-Range-Invalidate-by-VA-EL2-Inner-Shareable-img01.svg)
...
BaseADDR, bits [36:0]
:   When (IsFeatureImplemented(FEAT\_LPA2) && ([TCR\_EL2](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-2-General-system-control-registers/-D24-2-194-TCR-EL2--Translation-Control-Register--EL2-?lang=en#reg_aarch64_tcr_el2).DS == '1')) || (IsFeatureImplemented(FEAT\_D128) && ([TCR2\_EL2](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-2-General-system-control-registers/-D24-2-190-TCR2-EL2--Extended-Translation-Control-Register--EL2-?lang=en#reg_aarch64_tcr2_el2).D128 == '1')):
...
`When FEAT_XS is implemented TLBI RVAE2ISNXS{, <Xt>}`
:
  ...
  <tr>
   ...
   <td>
    ...
    if !(IsFeatureImplemented(FEAT_TLBIRANGE) && IsFeatureImplemented(FEAT_AA64)) then
        ...
        AArch64_TLBI_RVA(SecurityStateAtEL(EL2), Regime_EL2, VMID_NONE, Broadcast_ISH, TLBILevel_Any, TLBI_ExcludeXS, X{64}(t));
    elsif PSTATE.EL == EL3 then
        if !EL2Enabled() then
            Undefined();
        else
