...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-62-TLBI-VAE2--TLBI-VAE2NXS--TLB-Invalidate-by-VA--EL2>
...
![](images/0570-C5.5.62-TLBI-VAE2-TLBI-VAE2NXS-TLB-Invalidate-by-VA-EL2-img01.svg)
...
if !IsFeatureImplemented(FEAT_AA64) then
    ...
    AArch64_TLBI_VA(SecurityStateAtEL(EL2), Regime_EL2, VMID_NONE, Broadcast_NSH, TLBILevel_Any, TLBI_AllAttr, X{64}(t));
...
`When FEAT_XS is implemented TLBI VAE2NXS{, <Xt>}`
:
  ...
  <tr>
   ...
   <td>
    ...
    if !IsFeatureImplemented(FEAT_AA64) then
        ...
        AArch64_TLBI_VA(SecurityStateAtEL(EL2), Regime_EL2, VMID_NONE, Broadcast_NSH, TLBILevel_Any, TLBI_ExcludeXS, X{64}(t));
    elsif PSTATE.EL == EL3 then
        if !EL2Enabled() then
            Undefined();
        else
