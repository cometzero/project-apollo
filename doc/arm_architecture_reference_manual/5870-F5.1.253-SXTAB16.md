...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F5-T32-and-A32-Base-Instruction-Set-Instruction-Descriptions/-F5-1-Alphabetical-list-of-T32-and-A32-base-instruction-set-instructions/-F5-1-253-SXTAB16>
...
```
if Rn == ‘1111’ then See(“SXTB16”); end;
...
![](images/5870-F5.1.253-SXTAB16-img02.svg)
...
    R(d)[15:0]  = R(n)[15:0] + SignExtend{16}(rotated[7:0]);
    R(d)[31:16] = R(n)[31:16] + SignExtend{16}(rotated[23:16]);
end;
```
