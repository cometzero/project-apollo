...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-3-ADD--to-array--multiple-and-single-vector->
...
It has encodings from 2 classes: [Two ZA single-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-3-ADD--to-array--multiple-and-single-vector-?lang=en#isa_add_za_zzv_iclass_two_za_single_vectors) and [Four ZA single-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-3-ADD--to-array--multiple-and-single-vector-?lang=en#isa_add_za_zzv_iclass_four_za_single_vectors)

###### Two ZA single-vectors

###### (FEAT\_SME2 && (sz == '0' || FEAT\_SME\_I16I64))

![](images/2607-C9.2.3-ADD-to-array-multiple-and-single-vector-img01.svg)
...
![](images/2607-C9.2.3-ADD-to-array-multiple-and-single-vector-img02.svg)
