...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-9-ADDS--extended-register->
...
This instruction is used by the alias [CMN (extended register)](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-92-CMN--extended-register-?lang=en#isa_cmn_adds_addsub_ext).

![](images/0691-C6.2.9-ADDS-extended-register-img01.svg)
