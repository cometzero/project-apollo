...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-61-FAMIN>
...
It has encodings from 2 classes: [Two registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-61-FAMIN?lang=en#isa_famin_mz_zzw_iclass_two_registers) and [Four registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-61-FAMIN?lang=en#isa_famin_mz_zzw_iclass_four_registers)

###### Two registers

###### (FEAT\_SME2 && FEAT\_FAMINMAX)

![](images/2665-C9.2.61-FAMIN-img01.svg)
...
![](images/2665-C9.2.61-FAMIN-img02.svg)
...
        results[[r]][e*:esize] = FPAbsMin{esize}(element1, element2, FPCR());
    end;
end;
for r = 0 to nreg-1 do
    Z{VL}(dn+r) = results[[r]];
