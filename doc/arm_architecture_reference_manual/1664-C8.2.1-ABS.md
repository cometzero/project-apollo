...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-1-ABS>

##### C8.2.1 ABS

Absolute value (predicated)

This instruction calculates the absolute value of the signed integer in each active element of the source vector, and places the results in the corresponding elements of the destination vector. If the value in an element of the source vector is the most negative value, the result for that element is the same as the value in that element of the source vector. Inactive elements in the destination vector register remain unmodified or are set to zero, depending on whether merging or zeroing predication is selected.

It has encodings from 2 classes: [Merging](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-1-ABS?lang=en#isa_abs_z_p_z_iclass_merging) and [Zeroing](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-1-ABS?lang=en#isa_abs_z_p_z_iclass_zeroing)

###### Merging

###### (FEAT\_SVE || FEAT\_SME)

![](images/1664-C8.2.1-ABS-img01.svg)
...
![](images/1664-C8.2.1-ABS-img02.svg)
