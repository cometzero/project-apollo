...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-617-SQCVTN>
...
![](images/2280-C8.2.617-SQCVTN-img01.svg)
...
        result[(2*e + i)*:esize] = SignedSat{esize}(element);
    end;
end;
Z{VL}(d) = result;
```
