...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-19-AESE--indexed->
...
![](images/1682-C8.2.19-AESE-indexed-img02.svg)
...
        results[[r]][s*:128] = AESSubBytes(AESShiftRows(res));
    end;
end;
for r = 0 to nreg-1 do
    Z{VL}(dn + r) = results[[r]];
