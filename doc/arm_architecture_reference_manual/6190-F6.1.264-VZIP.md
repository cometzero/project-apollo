...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-264-VZIP>
...
![VZIP doubleword operation for data type 8](images/6190-F6.1.264-VZIP-img01.svg)

Figure F6-13 VZIP quadword operation for data type 32

![VZIP quadword operation for data type 32](images/6190-F6.1.264-VZIP-img02.svg)
...
It has encodings from the following instruction sets: A32 ([A1](/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-264-VZIP?lang=en#isa_vzip_iclass_a1)) and T32 ([T1](/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-264-VZIP?lang=en#isa_vzip_iclass_t1)).

###### A1

![](images/6190-F6.1.264-VZIP-img03.svg)
...
![](images/6190-F6.1.264-VZIP-img04.svg)
...
        else
            var zipped_q : bits(256);
            for e = 0 to (128 DIV esize) - 1 do
                zipped_q[(2*e)*:esize] = Q(d>>1)[e*:esize];
                zipped_q[(2*e+1)*:esize] = Q(m>>1)[e*:esize];
            end;
...
        else
            var zipped_d : bits(128);
            for e = 0 to (64 DIV esize) - 1 do
                zipped_d[(2*e)*:esize] = D(d)[e*:esize];
                zipped_d[(2*e+1)*:esize] = D(m)[e*:esize];
            end;
