# ​C6.2.257 LDUMINB, LDUMINAB, LDUMINALB, LDUMINLB

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-257-LDUMINB--LDUMINAB--LDUMINALB--LDUMINLB>
...
This instruction is used by the alias [STUMINB, STUMINLB](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-444-STUMINB--STUMINLB?lang=en#isa_stuminb_lduminb).

###### Integer

###### (FEAT\_LSE)

![](images/0939-C6.2.257-LDUMINB-LDUMINAB-LDUMINALB-LDUMINLB-img01.svg)
...
let accdesc : AccessDescriptor = CreateAccDescAtomicOp(MemAtomicOp_UMIN, acquire, release,
