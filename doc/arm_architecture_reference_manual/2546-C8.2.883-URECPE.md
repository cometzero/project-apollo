...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-883-URECPE>
...
It has encodings from 2 classes: [Merging](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-883-URECPE?lang=en#isa_urecpe_z_p_z_iclass_merging) and [Zeroing](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-883-URECPE?lang=en#isa_urecpe_z_p_z_iclass_zeroing)

###### Merging

###### (FEAT\_SVE2 || FEAT\_SME)

![](images/2546-C8.2.883-URECPE-img01.svg)
...
![](images/2546-C8.2.883-URECPE-img02.svg)
...
        result[e*:esize] = UnsignedRecipEstimate{esize}(element);
    end;
end;
Z{VL}(d) = result;
```
