...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-459-UZP2>
...
![UZP1 and UZP2 with the arrangement specifier 8B](images/1656-C7.2.459-UZP2-img01.svg)
...
![](images/1656-C7.2.459-UZP2-img02.svg)
...
let operandl : bits(datasize) = V{}(n);
let operandh : bits(datasize) = V{}(m);
var result : bits(datasize);
let zipped : bits(datasize*2) = operandh::operandl;
for e = 0 to elements-1 do
    result[e*:esize] = zipped[(2*e+part)*:esize];
end;
V{datasize}(d) = result;
```
