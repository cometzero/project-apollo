...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-931-WHILERW>
...
![](images/2594-C8.2.931-WHILERW-img01.svg)
...
let diff : integer = Abs(operand2 - operand1) DIVRM (esize DIV 8);
