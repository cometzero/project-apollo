...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-102-CLS>

##### C8.2.102 CLS

Count leading sign bits (predicated)

This instruction determines the number of consecutive sign bits, starting from the most significant bit in each active element of the source vector, and places the results in the corresponding elements of the destination vector. Inactive elements in the destination vector register remain unmodified or are set to zero, depending on whether merging or zeroing predication is selected.

It has encodings from 2 classes: [Merging](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-102-CLS?lang=en#isa_cls_z_p_z_iclass_merging) and [Zeroing](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-102-CLS?lang=en#isa_cls_z_p_z_iclass_zeroing)

###### Merging

###### (FEAT\_SVE || FEAT\_SME)

![](images/1765-C8.2.102-CLS-img01.svg)
...
![](images/1765-C8.2.102-CLS-img02.svg)
...
        result[e*:esize] = CountLeadingSignBits(element)[esize-1:0];
    end;
end;
Z{VL}(d) = result;
```
