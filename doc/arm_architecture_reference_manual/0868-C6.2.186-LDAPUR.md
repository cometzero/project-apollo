...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-186-LDAPUR>
...
`LDAPUR` loads from memory with AcquirePC semantics.
...
![](images/0868-C6.2.186-LDAPUR-img01.svg)
