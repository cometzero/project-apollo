...
![](images/1837-C8.2.174-FCVTN-img01.svg)
...
    result[(2*e + 0)*:8] = FPConvertFP8{8, 16}(element1, FPCR(), FPMR());
    result[(2*e + 1)*:8] = FPConvertFP8{8, 16}(element2, FPCR(), FPMR());
end;
Z{VL}(d) = result;
```
