...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-26-CLS--vector->
...
![](images/1223-C7.2.26-CLS-vector-img01.svg)
...
    let count : integer = CountLeadingSignBits(operand[e*:esize]);
