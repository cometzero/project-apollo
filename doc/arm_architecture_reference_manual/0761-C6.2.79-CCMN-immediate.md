...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-79-CCMN--immediate->
...
![](images/0761-C6.2.79-CCMN-immediate-img01.svg)
...
let imm : bits(datasize) = ZeroExtend{}(imm5);
```
