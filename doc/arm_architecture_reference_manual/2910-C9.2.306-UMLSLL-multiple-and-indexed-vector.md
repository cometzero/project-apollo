...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-306-UMLSLL--multiple-and-indexed-vector->
...
It has encodings from 6 classes: [One ZA quad-vector of 32-bit elements](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-306-UMLSLL--multiple-and-indexed-vector-?lang=en#isa_umlsll_za_zzi_iclass_one_za_quad_vector_of_32_bit_elements), [One ZA quad-vector of 64-bit elements](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-306-UMLSLL--multiple-and-indexed-vector-?lang=en#isa_umlsll_za_zzi_iclass_one_za_quad_vector_of_64_bit_elements), [Two ZA quad-vectors of 32-bit elements](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-306-UMLSLL--multiple-and-indexed-vector-?lang=en#isa_umlsll_za_zzi_iclass_two_za_quad_vectors_of_32_bit_elements), [Two ZA quad-vectors of 64-bit elements](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-306-UMLSLL--multiple-and-indexed-vector-?lang=en#isa_umlsll_za_zzi_iclass_two_za_quad_vectors_of_64_bit_elements), [Four ZA quad-vectors of 32-bit elements](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-306-UMLSLL--multiple-and-indexed-vector-?lang=en#isa_umlsll_za_zzi_iclass_four_za_quad_vectors_of_32_bit_elements), and [Four ZA quad-vectors of 64-bit elements](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-306-UMLSLL--multiple-and-indexed-vector-?lang=en#isa_umlsll_za_zzi_iclass_four_za_quad_vectors_of_64_bit_elements)

###### One ZA quad-vector of 32-bit elements

###### (FEAT\_SME2)

![](images/2910-C9.2.306-UMLSLL-multiple-and-indexed-vector-img01.svg)
...
![](images/2910-C9.2.306-UMLSLL-multiple-and-indexed-vector-img02.svg)
...
![](images/2910-C9.2.306-UMLSLL-multiple-and-indexed-vector-img03.svg)
...
![](images/2910-C9.2.306-UMLSLL-multiple-and-indexed-vector-img04.svg)
...
![](images/2910-C9.2.306-UMLSLL-multiple-and-indexed-vector-img05.svg)

###### Encoding

```
UMLSLL  ZA.S[<Wv>, <offs1>:<offs4>{, VGx4}], { <Zn1>.B-<Zn4>.B }, <Zm>.B[<index>]
```
...
![](images/2910-C9.2.306-UMLSLL-multiple-and-indexed-vector-img06.svg)
