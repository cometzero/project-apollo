...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-824-UMAXV>

##### C8.2.824 UMAXV

Unsigned maximum reduction to scalar

This instruction determines the unsigned maximum of the elements of the source vector, and places the result in the SIMD&FP scalar destination register. Inactive elements in the source vector are treated as zero.

###### SVE

###### (FEAT\_SVE || FEAT\_SME)

![](images/2487-C8.2.824-UMAXV-img01.svg)
