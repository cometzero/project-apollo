# ​C6.2.495 UMIN (register)

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-495-UMIN--register->
...
![](images/1177-C6.2.495-UMIN-register-img01.svg)
...
let result : integer = Min(UInt(operand1), UInt(operand2));
