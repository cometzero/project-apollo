...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-3-Common-event-numbers/-0x0035--ITLB-WALK--Instruction-TLB-access-with-at-least-one-translation-table-walk>

##### `0x0035`, ITLB\_WALK, Instruction TLB access with at least one translation table walk

The counter counts each access counted by [L1I\_TLB](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-3-Common-event-numbers/-0x0026--L1I-TLB--Level-1-instruction-TLB-access?lang=en#event_l1i_tlb) that causes a refill of an instruction TLB involving at least one translation table walk access.
