# ​D24.5.29 SPMACCESSR_EL1, System Performance Monitors Access Register (EL1)

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-5-Performance-Monitors-registers/-D24-5-29-SPMACCESSR-EL1--System-Performance-Monitors-Access-Register--EL1->

##### D24.5.29 SPMACCESSR\_EL1, System Performance Monitors Access Register (EL1)
...
![](images/5255-D24.5.29-SPMACCESSR_EL1-System-Performance-Monitors-Access-Register-EL1-img01.svg)
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     write System register accesses to System PMU &lt;m&gt; at EL0 are trapped to EL1, unless the instruction generates a higher priority exception.
    </p>
   </td>
  </tr>
  <tr>
...
`When FEAT_VHE is implemented MRS <Xt>, SPMACCESSR_EL12`
:
...
`When FEAT_VHE is implemented MSR SPMACCESSR_EL12, <Xt>`
:
