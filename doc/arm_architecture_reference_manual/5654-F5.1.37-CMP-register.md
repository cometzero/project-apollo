...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F5-T32-and-A32-Base-Instruction-Set-Instruction-Descriptions/-F5-1-Alphabetical-list-of-T32-and-A32-base-instruction-set-instructions/-F5-1-37-CMP--register->
...
![](images/5654-F5.1.37-CMP-register-img02.svg)
...
![](images/5654-F5.1.37-CMP-register-img03.svg)
...
```
let n : integer = UInt(N::Rn);
let m : integer = UInt(Rm);
let shift_t : SRType = SRType_LSL;
let shift_n : integer = 0;
if n < 8 && m < 8 then UnpredictableProcedure(); end;
...
![](images/5654-F5.1.37-CMP-register-img04.svg)
