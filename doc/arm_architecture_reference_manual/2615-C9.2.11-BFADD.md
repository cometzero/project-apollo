...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-11-BFADD>
...
It has encodings from 2 classes: [Two ZA single-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-11-BFADD?lang=en#isa_bfadd_za_zw_iclass_two_za_single_vectors) and [Four ZA single-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-11-BFADD?lang=en#isa_bfadd_za_zw_iclass_four_za_single_vectors)

###### Two ZA single-vectors

###### (FEAT\_SME\_B16B16)

![](images/2615-C9.2.11-BFADD-img01.svg)
...
![](images/2615-C9.2.11-BFADD-img02.svg)
...
        result[e*:16] = BFAdd_ZA(element1, element2, FPCR());
    end;
