...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-3-Common-event-numbers/-0x8135--ITLB-HWUPD--Instruction-TLB-hardware-update-of-translation-table>

##### `0x8135`, ITLB\_HWUPD, Instruction TLB hardware update of translation table

The counter counts each access counted by [L1I\_TLB](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-3-Common-event-numbers/-0x0026--L1I-TLB--Level-1-instruction-TLB-access?lang=en#event_l1i_tlb) that causes a hardware update of a translation table entry.
