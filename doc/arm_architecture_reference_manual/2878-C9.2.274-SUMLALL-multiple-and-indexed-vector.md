...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-274-SUMLALL--multiple-and-indexed-vector->
...
It has encodings from 3 classes: [One ZA quad-vector](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-274-SUMLALL--multiple-and-indexed-vector-?lang=en#isa_sumlall_za_zzi_iclass_one_za_quad_vector), [Two ZA quad-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-274-SUMLALL--multiple-and-indexed-vector-?lang=en#isa_sumlall_za_zzi_iclass_two_za_quad_vectors), and [Four ZA quad-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-274-SUMLALL--multiple-and-indexed-vector-?lang=en#isa_sumlall_za_zzi_iclass_four_za_quad_vectors)

###### One ZA quad-vector

###### (FEAT\_SME2)

![](images/2878-C9.2.274-SUMLALL-multiple-and-indexed-vector-img01.svg)
...
![](images/2878-C9.2.274-SUMLALL-multiple-and-indexed-vector-img02.svg)
...
![](images/2878-C9.2.274-SUMLALL-multiple-and-indexed-vector-img03.svg)

###### Encoding

```
SUMLALL  ZA.S[<Wv>, <offs1>:<offs4>{, VGx4}], { <Zn1>.B-<Zn4>.B }, <Zm>.B[<index>]
```
