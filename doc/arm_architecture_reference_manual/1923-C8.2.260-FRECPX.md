...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-260-FRECPX>
...
![](images/1923-C8.2.260-FRECPX-img02.svg)
...
        result[e*:esize] = FPRecpX{esize}(element, FPCR());
    end;
end;
Z{VL}(d) = result;
```
