...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-41-BIC--shifted-register->

##### C6.2.41 BIC (shifted register)

Bitwise bit clear (shifted register)

This instruction performs a bitwise AND between a register value and the complement of an optionally-shifted register value, and writes the result to the destination register.

![](images/0723-C6.2.41-BIC-shifted-register-img01.svg)
...
X{datasize}(d) = operand1 AND NOT(operand2);
```
