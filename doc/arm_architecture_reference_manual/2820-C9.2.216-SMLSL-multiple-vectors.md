...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-216-SMLSL--multiple-vectors->
...
It has encodings from 2 classes: [Two ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-216-SMLSL--multiple-vectors-?lang=en#isa_smlsl_za_zzw_iclass_two_za_double_vectors) and [Four ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-216-SMLSL--multiple-vectors-?lang=en#isa_smlsl_za_zzw_iclass_four_za_double_vectors)

###### Two ZA double-vectors

###### (FEAT\_SME2)

![](images/2820-C9.2.216-SMLSL-multiple-vectors-img01.svg)
...
![](images/2820-C9.2.216-SMLSL-multiple-vectors-img02.svg)
