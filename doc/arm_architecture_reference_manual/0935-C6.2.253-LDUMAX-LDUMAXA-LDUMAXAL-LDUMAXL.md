# ​C6.2.253 LDUMAX, LDUMAXA, LDUMAXAL, LDUMAXL

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-253-LDUMAX--LDUMAXA--LDUMAXAL--LDUMAXL>
...
This instruction is used by the alias [STUMAX, STUMAXL](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-440-STUMAX--STUMAXL?lang=en#isa_stumax_ldumax).

###### Integer

###### (FEAT\_LSE)

![](images/0935-C6.2.253-LDUMAX-LDUMAXA-LDUMAXAL-LDUMAXL-img01.svg)
