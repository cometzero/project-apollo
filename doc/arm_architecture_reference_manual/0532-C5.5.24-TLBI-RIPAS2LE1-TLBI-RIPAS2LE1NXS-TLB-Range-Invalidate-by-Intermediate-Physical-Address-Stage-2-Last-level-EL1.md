...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-24-TLBI-RIPAS2LE1--TLBI-RIPAS2LE1NXS--TLB-Range-Invalidate-by-Intermediate-Physical-Address--Stage-2--Last-level--EL1>
...
![](images/0532-C5.5.24-TLBI-RIPAS2LE1-TLBI-RIPAS2LE1NXS-TLB-Range-Invalidate-by-Intermediate-Physical-Address-Stage-2-Last-level-EL1-img01.svg)
...
`When FEAT_XS is implemented TLBI RIPAS2LE1NXS{, <Xt>}`
:
  ...
  <tr>
   ...
   <td>
    ...
    if !(IsFeatureImplemented(FEAT_TLBIRANGE) && IsFeatureImplemented(FEAT_AA64)) then
        ...
        AArch64_TLBI_RIPAS2(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_NSH, TLBILevel_Last, TLBI_ExcludeXS, X{64}(t));
    elsif PSTATE.EL == EL3 then
        if !EL2Enabled() then
            return;
        else
