...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-64-TLBI-VAE2OS--TLBI-VAE2OSNXS--TLB-Invalidate-by-VA--EL2--Outer-Shareable>
...
Configuration
:   This system instruction is present only when FEAT\_TLBIOS is implemented and FEAT\_AA64 is implemented. Otherwise, direct accesses to TLBI VAE2OS, TLBI VAE2OSNXS are UNDEFINED.
...
![](images/0572-C5.5.64-TLBI-VAE2OS-TLBI-VAE2OSNXS-TLB-Invalidate-by-VA-EL2-Outer-Shareable-img01.svg)
...
if !(IsFeatureImplemented(FEAT_TLBIOS) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    AArch64_TLBI_VA(SecurityStateAtEL(EL2), Regime_EL2, VMID_NONE, Broadcast_OSH, TLBILevel_Any, TLBI_AllAttr, X{64}(t));
...
`When FEAT_XS is implemented TLBI VAE2OSNXS{, <Xt>}`
:
  ...
  <tr>
   ...
   <td>
    ...
    if !(IsFeatureImplemented(FEAT_TLBIOS) && IsFeatureImplemented(FEAT_AA64)) then
        ...
        AArch64_TLBI_VA(SecurityStateAtEL(EL2), Regime_EL2, VMID_NONE, Broadcast_OSH, TLBILevel_Any, TLBI_ExcludeXS, X{64}(t));
    elsif PSTATE.EL == EL3 then
        if !EL2Enabled() then
            Undefined();
        else
