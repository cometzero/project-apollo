...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-161-FMUL--vector->
...
It has encodings from 2 classes: [Half-precision](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-161-FMUL--vector-?lang=en#isa_fmul_advsimd_vec_iclass_half_precision) and [Single-precision and double-precision](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-161-FMUL--vector-?lang=en#isa_fmul_advsimd_vec_iclass_single_precision_and_double_precision)

###### Half-precision

###### (FEAT\_AdvSIMD && FEAT\_FP16)

![](images/1358-C7.2.161-FMUL-vector-img01.svg)
...
![](images/1358-C7.2.161-FMUL-vector-img02.svg)
...
    result[e*:esize] = FPMul{esize}(element1, element2, FPCR());
end;
V{datasize}(d) = result;
```
