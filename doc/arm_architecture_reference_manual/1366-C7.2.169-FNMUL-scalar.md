...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-169-FNMUL--scalar->
...
![](images/1366-C7.2.169-FNMUL-scalar-img01.svg)
...
let product : bits(esize) = FPMul{}(operand1, operand2, FPCR());
result[0+:esize]  = FPNeg{esize}(product, FPCR());
V{128}(d) = result;
```
