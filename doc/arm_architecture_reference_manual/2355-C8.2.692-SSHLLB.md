...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-692-SSHLLB>
...
![](images/2355-C8.2.692-SSHLLB-img01.svg)
...
    let element : bits(esize) = operand[(2*e + 0)*:esize];
