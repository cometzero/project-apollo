...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-47-TLBI-RVALE2--TLBI-RVALE2NXS--TLB-Range-Invalidate-by-VA--Last-level--EL2>
...
Configuration
:   This system instruction is present only when FEAT\_TLBIRANGE is implemented and FEAT\_AA64 is implemented. Otherwise, direct accesses to TLBI RVALE2, TLBI RVALE2NXS are UNDEFINED.
...
![](images/0555-C5.5.47-TLBI-RVALE2-TLBI-RVALE2NXS-TLB-Range-Invalidate-by-VA-Last-level-EL2-img01.svg)
...
`When FEAT_XS is implemented TLBI RVALE2NXS{, <Xt>}`
:
  ...
  <tr>
   ...
   <td>
    ...
    if !(IsFeatureImplemented(FEAT_TLBIRANGE) && IsFeatureImplemented(FEAT_AA64)) then
        ...
        AArch64_TLBI_RVA(SecurityStateAtEL(EL2), Regime_EL2, VMID_NONE, Broadcast_NSH, TLBILevel_Last, TLBI_ExcludeXS, X{64}(t));
    elsif PSTATE.EL == EL3 then
        if !EL2Enabled() then
            Undefined();
        else
