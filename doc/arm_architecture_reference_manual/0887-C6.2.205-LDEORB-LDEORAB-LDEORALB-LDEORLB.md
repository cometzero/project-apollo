# ​C6.2.205 LDEORB, LDEORAB, LDEORALB, LDEORLB

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-205-LDEORB--LDEORAB--LDEORALB--LDEORLB>
...
This instruction is used by the alias [STEORB, STEORLB](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-393-STEORB--STEORLB?lang=en#isa_steorb_ldeorb).

###### Integer

###### (FEAT\_LSE)

![](images/0887-C6.2.205-LDEORB-LDEORAB-LDEORALB-LDEORLB-img01.svg)
