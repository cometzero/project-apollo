...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-228-FMLALLTT--indexed->
...
![](images/1891-C8.2.228-FMLALLTT-indexed-img01.svg)
...
    let element1 : bits(8) = operand1[(4 * e + 3)*:8];
