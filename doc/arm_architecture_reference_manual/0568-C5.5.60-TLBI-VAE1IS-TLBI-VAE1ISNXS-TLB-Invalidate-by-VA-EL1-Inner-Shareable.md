...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-60-TLBI-VAE1IS--TLBI-VAE1ISNXS--TLB-Invalidate-by-VA--EL1--Inner-Shareable>
...
![](images/0568-C5.5.60-TLBI-VAE1IS-TLBI-VAE1ISNXS-TLB-Invalidate-by-VA-EL1-Inner-Shareable-img01.svg)
...
`When FEAT_XS is implemented TLBI VAE1ISNXS{, <Xt>}`
:
   ...
   <td>
    ...
    if !IsFeatureImplemented(FEAT_AA64) then
        ...
        if EL2Enabled() && (HCR_EL2().TTLB == '1' || HCR_EL2().TTLBIS == '1') then
            ...
            AArch64_TLBI_VA(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_ISH, TLBILevel_Any, TLBI_ExcludeXS, X{64}(t));
        end;
    elsif PSTATE.EL == EL2 then
        AArch64_TLBI_VA(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_ISH, TLBILevel_Any, TLBI_ExcludeXS, X{64}(t));
    elsif PSTATE.EL == EL3 then
