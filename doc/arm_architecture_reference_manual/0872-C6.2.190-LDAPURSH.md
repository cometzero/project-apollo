...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-190-LDAPURSH>
...
`LDAPURSH` loads from memory with AcquirePC semantics.
...
![](images/0872-C6.2.190-LDAPURSH-img01.svg)
