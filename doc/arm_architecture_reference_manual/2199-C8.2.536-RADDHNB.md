...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-536-RADDHNB>
...
![](images/2199-C8.2.536-RADDHNB-img01.svg)
...
    result[(2*e + 0)*:halfesize] = res[halfesize-1:0];
