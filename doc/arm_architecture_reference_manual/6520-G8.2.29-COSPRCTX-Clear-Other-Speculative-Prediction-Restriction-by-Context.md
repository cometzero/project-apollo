...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-G-The-AArch32-System-Level-Architecture/-Chapter-G8-AArch32-System-Register-Descriptions/-G8-2-General-system-control-registers/-G8-2-29-COSPRCTX--Clear-Other-Speculative-Prediction-Restriction-by-Context>
...
![](images/6520-G8.2.29-COSPRCTX-Clear-Other-Speculative-Prediction-Restriction-by-Context-img01.svg)
...
if !(IsFeatureImplemented(FEAT_AA32) && IsFeatureImplemented(FEAT_SPECRES2)) then
    ...
    elsif EL2Enabled() && (IsFeatureImplemented(FEAT_AA64EL1) && !ELUsingAArch32(EL1)) && EffectivelyAtEL0NotInHost() && IsFeatureImplemented(FEAT_FGT) && (!HaveEL(EL3) || SCR_EL3().FGTEn == '1') && HFGITR_EL2().COSPRCTX == '1' then
        AArch64_AArch32SystemAccessTrap(EL2, 0x03);
