# ​C6.2.231 LDSET, LDSETA, LDSETAL, LDSETL

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-231-LDSET--LDSETA--LDSETAL--LDSETL>
...
This instruction is used by the alias [STSET, STSETL](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-421-STSET--STSETL?lang=en#isa_stset_ldset).

###### Integer

###### (FEAT\_LSE)

![](images/0913-C6.2.231-LDSET-LDSETA-LDSETAL-LDSETL-img01.svg)
