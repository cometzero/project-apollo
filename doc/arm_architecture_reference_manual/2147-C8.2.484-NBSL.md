...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-484-NBSL>
...
![](images/2147-C8.2.484-NBSL-img01.svg)
...
Z{VL}(dn) = NOT((operand1 AND operand3) OR (operand2 AND NOT(operand3)));
```
