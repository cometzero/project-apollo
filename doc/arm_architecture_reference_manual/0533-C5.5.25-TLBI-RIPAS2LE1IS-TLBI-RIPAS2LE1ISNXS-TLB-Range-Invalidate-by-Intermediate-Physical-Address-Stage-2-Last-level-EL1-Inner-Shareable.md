...
![](images/0533-C5.5.25-TLBI-RIPAS2LE1IS-TLBI-RIPAS2LE1ISNXS-TLB-Range-Invalidate-by-Intermediate-Physical-Address-Stage-2-Last-level-EL1-Inner-Shareable-img01.svg)
...
`When FEAT_XS is implemented TLBI RIPAS2LE1ISNXS{, <Xt>}`
:
  ...
  <tr>
   ...
   <td>
    ...
    if !(IsFeatureImplemented(FEAT_TLBIRANGE) && IsFeatureImplemented(FEAT_AA64)) then
        ...
        AArch64_TLBI_RIPAS2(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_ISH, TLBILevel_Last, TLBI_ExcludeXS, X{64}(t));
    elsif PSTATE.EL == EL3 then
        if !EL2Enabled() then
            return;
        else
