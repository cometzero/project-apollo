...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-3-Common-event-numbers/-0x8137--ITLB-STEP--Instruction-TLB-translation-table-walk--step>

##### `0x8137`, ITLB\_STEP, Instruction TLB translation table walk, step

The counter counts each translation table walk access due to a refill or update of an instruction TLB.
