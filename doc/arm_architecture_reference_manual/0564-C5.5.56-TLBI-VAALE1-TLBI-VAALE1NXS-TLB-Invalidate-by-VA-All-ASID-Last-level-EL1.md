...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-56-TLBI-VAALE1--TLBI-VAALE1NXS--TLB-Invalidate-by-VA--All-ASID--Last-level--EL1>
...
![](images/0564-C5.5.56-TLBI-VAALE1-TLBI-VAALE1NXS-TLB-Invalidate-by-VA-All-ASID-Last-level-EL1-img01.svg)
...
if !IsFeatureImplemented(FEAT_AA64) then
    ...
    if EL2Enabled() && HCR_EL2().TTLB == '1' then
        ...
        AArch64_TLBI_VAA(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_NSH, TLBILevel_Last, TLBI_AllAttr, X{64}(t));
    end;
...
`When FEAT_XS is implemented TLBI VAALE1NXS{, <Xt>}`
:
   ...
   <td>
    ...
    if !IsFeatureImplemented(FEAT_AA64) then
        ...
        if EL2Enabled() && HCR_EL2().TTLB == '1' then
            ...
            AArch64_TLBI_VAA(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_NSH, TLBILevel_Last, TLBI_ExcludeXS, X{64}(t));
        end;
    elsif PSTATE.EL == EL2 then
        AArch64_TLBI_VAA(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_NSH, TLBILevel_Last, TLBI_ExcludeXS, X{64}(t));
    elsif PSTATE.EL == EL3 then
