# ​C6.2.370 SMAX (immediate)

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-370-SMAX--immediate->
...
![](images/1052-C6.2.370-SMAX-immediate-img01.svg)
...
let result : integer = Max(SInt(operand1), imm);
