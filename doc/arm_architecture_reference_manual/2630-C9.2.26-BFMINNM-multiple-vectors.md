...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-26-BFMINNM--multiple-vectors->
...
It has encodings from 2 classes: [Two registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-26-BFMINNM--multiple-vectors-?lang=en#isa_bfminnm_mz_zzw_iclass_two_registers) and [Four registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-26-BFMINNM--multiple-vectors-?lang=en#isa_bfminnm_mz_zzw_iclass_four_registers)

###### Two registers

###### (FEAT\_SME2 && FEAT\_SVE\_B16B16)

![](images/2630-C9.2.26-BFMINNM-multiple-vectors-img01.svg)
...
![](images/2630-C9.2.26-BFMINNM-multiple-vectors-img02.svg)
...
        results[[r]][e*:16] = BFMinNum{16}(element1, element2, FPCR());
    end;
end;
for r = 0 to nreg-1 do
    Z{VL}(dn+r) = results[[r]];
