...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-483-NANDS>

##### C8.2.483 NANDS

Bitwise NAND predicates, setting the condition flags

This instruction performs a bitwise NAND between the active elements of the first source predicate and the corresponding elements of the second source predicate, and places the results in the corresponding elements of the destination predicate. Inactive elements in the destination predicate register are set to zero. This instruction sets the First (N), None (Z), and !Last (C) condition flags based on the predicate result, and sets the V flag to zero.

###### Setting the condition flags

###### (FEAT\_SVE || FEAT\_SME)

![](images/2146-C8.2.483-NANDS-img01.svg)
...
        result[e*:psize] = ZeroExtend{psize}(NOT(element1 AND element2));
    else
