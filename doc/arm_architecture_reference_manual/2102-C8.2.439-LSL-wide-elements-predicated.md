...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-439-LSL--wide-elements--predicated->
...
![](images/2102-C8.2.439-LSL-wide-elements-predicated-img01.svg)
...
        result[e*:esize] = LSL(element1, shift);
    else
