...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-676-SQSHRUNB>
...
![](images/2339-C8.2.676-SQSHRUNB-img01.svg)
...
    let res : integer = SInt(element) >> shift;
