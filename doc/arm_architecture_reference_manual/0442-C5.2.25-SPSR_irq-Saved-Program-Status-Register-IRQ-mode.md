# ​C5.2.25 SPSR_irq, Saved Program Status Register (IRQ mode)

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-2-Special-purpose-registers/-C5-2-25-SPSR-irq--Saved-Program-Status-Register--IRQ-mode->

##### C5.2.25 SPSR\_irq, Saved Program Status Register (IRQ mode)
...
:   If EL1 only supports execution in AArch64 state, this register is RES0 from EL2 and EL3.
    ...
    AArch64 System register SPSR\_irq bits [31:0] are architecturally mapped to AArch32 System register [SPSR\_irq](/documentation/ddi0487/mc/-Part-G-The-AArch32-System-Level-Architecture/-Chapter-G8-AArch32-System-Register-Descriptions/-G8-2-General-system-control-registers/-G8-2-132-SPSR-irq--Saved-Program-Status-Register--IRQ-mode-?lang=en#reg_aarch32_spsr_irq)[31:0].
...
:   ![](images/0442-C5.2.25-SPSR_irq-Saved-Program-Status-Register-IRQ-mode-img01.svg)

Bits [63:0]
:   Reserved, RES0.

Otherwise:
:   ![](images/0442-C5.2.25-SPSR_irq-Saved-Program-Status-Register-IRQ-mode-img02.svg)
