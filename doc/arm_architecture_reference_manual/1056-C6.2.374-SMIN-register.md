# ​C6.2.374 SMIN (register)

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-374-SMIN--register->
...
![](images/1056-C6.2.374-SMIN-register-img01.svg)
...
let result : integer = Min(SInt(operand1), SInt(operand2));
