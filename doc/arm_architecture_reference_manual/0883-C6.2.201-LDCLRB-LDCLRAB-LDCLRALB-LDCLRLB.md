# ​C6.2.201 LDCLRB, LDCLRAB, LDCLRALB, LDCLRLB

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-201-LDCLRB--LDCLRAB--LDCLRALB--LDCLRLB>
...
This instruction is used by the alias [STCLRB, STCLRLB](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-390-STCLRB--STCLRLB?lang=en#isa_stclrb_ldclrb).

###### Integer

###### (FEAT\_LSE)

![](images/0883-C6.2.201-LDCLRB-LDCLRAB-LDCLRALB-LDCLRLB-img01.svg)
