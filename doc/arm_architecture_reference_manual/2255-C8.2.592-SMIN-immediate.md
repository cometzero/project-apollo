...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-592-SMIN--immediate->
...
![](images/2255-C8.2.592-SMIN-immediate-img01.svg)
...
    result[e*:esize] = Min(element1, imm)[esize-1:0];
end;
Z{VL}(dn) = result;
```
