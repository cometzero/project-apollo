...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-125-FSCALE--multiple-and-single-vector->
...
It has encodings from 2 classes: [Two registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-125-FSCALE--multiple-and-single-vector-?lang=en#isa_fscale_mz_zzv_iclass_two_registers) and [Four registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-125-FSCALE--multiple-and-single-vector-?lang=en#isa_fscale_mz_zzv_iclass_four_registers)

###### Two registers

###### (FEAT\_SME2 && FEAT\_FP8)

![](images/2729-C9.2.125-FSCALE-multiple-and-single-vector-img01.svg)
...
![](images/2729-C9.2.125-FSCALE-multiple-and-single-vector-img02.svg)
...
        results[[r]][e*:esize] = FPScale{esize}(element1, element2, FPCR());
    end;
end;
for r = 0 to nreg-1 do
    Z{VL}(dn+r) = results[[r]];
