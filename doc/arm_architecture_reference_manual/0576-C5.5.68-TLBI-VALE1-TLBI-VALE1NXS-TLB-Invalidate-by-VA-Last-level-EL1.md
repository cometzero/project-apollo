...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-68-TLBI-VALE1--TLBI-VALE1NXS--TLB-Invalidate-by-VA--Last-level--EL1>
...
![](images/0576-C5.5.68-TLBI-VALE1-TLBI-VALE1NXS-TLB-Invalidate-by-VA-Last-level-EL1-img01.svg)
...
if !IsFeatureImplemented(FEAT_AA64) then
    ...
    elsif EL2Enabled() && IsFeatureImplemented(FEAT_FGT) && (!HaveEL(EL3) || SCR_EL3().FGTEn == '1') && HFGITR_EL2().TLBIVALE1 == '1' then
        AArch64_SystemAccessTrap(EL2, 0x18);
    else
...
`When FEAT_XS is implemented TLBI VALE1NXS{, <Xt>}`
:
  ...
  <tr>
   ...
   <td>
    ...
    if !IsFeatureImplemented(FEAT_AA64) then
        ...
        if EL2Enabled() && HCR_EL2().TTLB == '1' then
            AArch64_SystemAccessTrap(EL2, 0x18);
        elsif EL2Enabled() && IsFeatureImplemented(FEAT_FGT) && (!HaveEL(EL3) || SCR_EL3().FGTEn == '1') && IsFeatureImplemented(FEAT_HCX) && (!IsHCRXEL2Enabled() || HCRX_EL2().FGTnXS == '0') && HFGITR_EL2().TLBIVALE1 == '1' then
            AArch64_SystemAccessTrap(EL2, 0x18);
        else
