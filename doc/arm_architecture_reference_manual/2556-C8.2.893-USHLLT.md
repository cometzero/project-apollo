...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-893-USHLLT>
...
![](images/2556-C8.2.893-USHLLT-img01.svg)
...
    let shifted_value : integer = UInt(element) << shift;
