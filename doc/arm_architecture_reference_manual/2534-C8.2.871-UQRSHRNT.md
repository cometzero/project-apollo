...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-871-UQRSHRNT>
...
![](images/2534-C8.2.871-UQRSHRNT-img01.svg)
...
    result[(2*e + 1)*:esize] = UnsignedSat{esize}(res);
end;
Z{VL}(d) = result;
```
