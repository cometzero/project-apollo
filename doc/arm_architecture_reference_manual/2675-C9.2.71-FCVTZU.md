...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-71-FCVTZU>
...
It has encodings from 2 classes: [Two registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-71-FCVTZU?lang=en#isa_fcvtzu_mz_z_iclass_two_registers) and [Four registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-71-FCVTZU?lang=en#isa_fcvtzu_mz_z_iclass_four_registers)

###### Two registers

###### (FEAT\_SME2)

![](images/2675-C9.2.71-FCVTZU-img01.svg)
...
![](images/2675-C9.2.71-FCVTZU-img02.svg)
...
        results[[r]][e*:32] = FPToFixed{32, 32}(element, 0, unsigned, FPCR(), rounding);
    end;
end;
for r = 0 to nreg-1 do
    Z{VL}(d+r) = results[[r]];
