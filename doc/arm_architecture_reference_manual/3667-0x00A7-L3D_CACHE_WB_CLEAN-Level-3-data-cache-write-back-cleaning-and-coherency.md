...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-3-Common-event-numbers/-0x00A7--L3D-CACHE-WB-CLEAN--Level-3-data-cache-write-back--cleaning-and-coherency>

##### `0x00A7`, L3D\_CACHE\_WB\_CLEAN, Level 3 data cache write-back, cleaning and coherency

The counter counts each write-back counted by [L3D\_CACHE\_WB](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-3-Common-event-numbers/-0x002C--L3D-CACHE-WB--Level-3-data-cache-write-back?lang=en#event_l3d_cache_wb) that occurs because of a coherency operation made by another PE or, optionally, the execution of a cache maintenance instruction..
...
In all cases, the event is counted only if the write-back is also an [L3D\_CACHE\_WB](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-3-Common-event-numbers/-0x002C--L3D-CACHE-WB--Level-3-data-cache-write-back?lang=en#event_l3d_cache_wb) event. This means that, if the cache is shared, the write-back is counted only if it is attributable to the PE counting the event, as defined by [L3D\_CACHE\_WB](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-3-Common-event-numbers/-0x002C--L3D-CACHE-WB--Level-3-data-cache-write-back?lang=en#event_l3d_cache_wb).
