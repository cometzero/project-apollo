...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-17-AESD--vectors->
...
![](images/1680-C8.2.17-AESD-vectors-img01.svg)
...
    result[s*:128] = AESInvSubBytes(AESInvShiftRows(result[s*:128]));
end;
Z{VL}(dn) = result;
```
