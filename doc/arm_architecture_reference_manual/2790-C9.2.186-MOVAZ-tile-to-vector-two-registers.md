...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-186-MOVAZ--tile-to-vector--two-registers->
...
It has encodings from 4 classes: [8-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-186-MOVAZ--tile-to-vector--two-registers-?lang=en#isa_movaz_mz2_za_iclass_8_bit), [16-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-186-MOVAZ--tile-to-vector--two-registers-?lang=en#isa_movaz_mz2_za_iclass_16_bit), [32-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-186-MOVAZ--tile-to-vector--two-registers-?lang=en#isa_movaz_mz2_za_iclass_32_bit), and [64-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-186-MOVAZ--tile-to-vector--two-registers-?lang=en#isa_movaz_mz2_za_iclass_64_bit)

###### 8-bit

###### (FEAT\_SME2p1)

![](images/2790-C9.2.186-MOVAZ-tile-to-vector-two-registers-img01.svg)
...
![](images/2790-C9.2.186-MOVAZ-tile-to-vector-two-registers-img02.svg)
...
![](images/2790-C9.2.186-MOVAZ-tile-to-vector-two-registers-img03.svg)

###### Encoding

```
MOVAZ  { <Zd1>.S-<Zd2>.S }, <ZAn><HV>.S[<Ws>, <offs1>:<offs2>]
```
...
![](images/2790-C9.2.186-MOVAZ-tile-to-vector-two-registers-img04.svg)

###### Encoding

```
MOVAZ  { <Zd1>.D-<Zd2>.D }, <ZAn><HV>.D[<Ws>, <offs1>:<offs2>]
```
