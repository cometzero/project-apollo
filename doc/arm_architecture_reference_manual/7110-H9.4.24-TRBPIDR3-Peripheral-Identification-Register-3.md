...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-H-External-Debug/-Chapter-H9-External-Debug-Register-Descriptions/-H9-4-External-Trace-Buffer-registers/-H9-4-24-TRBPIDR3--Peripheral-Identification-Register-3>
...
![](images/7110-H9.4.24-TRBPIDR3-Peripheral-Identification-Register-3-img01.svg)
...
:   Indicates either the revision of the component, or whether the component has been modified.
    ...
    [TRBPIDR3](/documentation/ddi0487/mc/-Part-H-External-Debug/-Chapter-H9-External-Debug-Register-Descriptions/-H9-4-External-Trace-Buffer-registers/-H9-4-24-TRBPIDR3--Peripheral-Identification-Register-3?lang=en#reg_ext_trbpidr3).CMOD might also indicate component modifications.
...
:   Indicates whether the component has been modified from its original behavior. Examples of modifications include errata fixes or metal fixes after implementation. Usually this value would be zero unless a modification has been performed. If the field is required for indicating component modifications, Arm recommends that component designers ensure that it can be changed by a metal fix, for example by driving it from registers that reset to zero.
    ...
    [TRBPIDR3](/documentation/ddi0487/mc/-Part-H-External-Debug/-Chapter-H9-External-Debug-Register-Descriptions/-H9-4-External-Trace-Buffer-registers/-H9-4-24-TRBPIDR3--Peripheral-Identification-Register-3?lang=en#reg_ext_trbpidr3).REVAND might also indicate component modifications.
