...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-54-BFMINNM>
...
![](images/1717-C8.2.54-BFMINNM-img01.svg)
...
        result[e*:16] = BFMinNum{16}(element1, element2, FPCR());
    else
