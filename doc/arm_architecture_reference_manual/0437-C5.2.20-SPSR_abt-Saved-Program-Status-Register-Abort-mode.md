# ​C5.2.20 SPSR_abt, Saved Program Status Register (Abort mode)

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-2-Special-purpose-registers/-C5-2-20-SPSR-abt--Saved-Program-Status-Register--Abort-mode->

##### C5.2.20 SPSR\_abt, Saved Program Status Register (Abort mode)
...
:   If EL1 only supports execution in AArch64 state, this register is RES0 from EL2 and EL3.
    ...
    AArch64 System register SPSR\_abt bits [31:0] are architecturally mapped to AArch32 System register [SPSR\_abt](/documentation/ddi0487/mc/-Part-G-The-AArch32-System-Level-Architecture/-Chapter-G8-AArch32-System-Register-Descriptions/-G8-2-General-system-control-registers/-G8-2-129-SPSR-abt--Saved-Program-Status-Register--Abort-mode-?lang=en#reg_aarch32_spsr_abt)[31:0].
...
:   ![](images/0437-C5.2.20-SPSR_abt-Saved-Program-Status-Register-Abort-mode-img01.svg)

Bits [63:0]
:   Reserved, RES0.

Otherwise:
:   ![](images/0437-C5.2.20-SPSR_abt-Saved-Program-Status-Register-Abort-mode-img02.svg)
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    Other values are reserved. If SPSR\_abt.M[4:0] has a Reserved value, or a value for an unimplemented Exception level, executing an exception return operation in Abort mode is an illegal return event, as described in [‘Illegal return events from AArch32 state’](/documentation/ddi0487/mc/-Part-G-The-AArch32-System-Level-Architecture/-Chapter-G1-The-AArch32-System-Level-Programmers--Model/-G1-15-Exception-return-to-an-Exception-level-using-AArch32/-G1-15-3-Illegal-return-events-from-AArch32-state?lang=en#chdddjdb).
