...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-303-UMLSL--multiple-and-indexed-vector->
...
It has encodings from 3 classes: [One ZA double-vector](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-303-UMLSL--multiple-and-indexed-vector-?lang=en#isa_umlsl_za_zzi_iclass_one_za_double_vector), [Two ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-303-UMLSL--multiple-and-indexed-vector-?lang=en#isa_umlsl_za_zzi_iclass_two_za_double_vectors), and [Four ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-303-UMLSL--multiple-and-indexed-vector-?lang=en#isa_umlsl_za_zzi_iclass_four_za_double_vectors)

###### One ZA double-vector

###### (FEAT\_SME2)

![](images/2907-C9.2.303-UMLSL-multiple-and-indexed-vector-img01.svg)
...
![](images/2907-C9.2.303-UMLSL-multiple-and-indexed-vector-img02.svg)
...
![](images/2907-C9.2.303-UMLSL-multiple-and-indexed-vector-img03.svg)

###### Encoding

```
UMLSL  ZA.S[<Wv>, <offs1>:<offs2>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H[<index>]
```
