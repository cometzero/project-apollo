...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-8-ADDVA>
...
It has encodings from 2 classes: [32-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-8-ADDVA?lang=en#isa_addva_za_pp_z_iclass_32_bit) and [64-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-8-ADDVA?lang=en#isa_addva_za_pp_z_iclass_64_bit)

###### 32-bit

###### (FEAT\_SME)

![](images/2612-C9.2.8-ADDVA-img01.svg)
...
![](images/2612-C9.2.8-ADDVA-img02.svg)
...
    let element : bits(esize) = operand_src[row*:esize];
