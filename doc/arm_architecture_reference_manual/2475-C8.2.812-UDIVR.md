...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-812-UDIVR>
...
![](images/2475-C8.2.812-UDIVR-img01.svg)
...
        let divisor : integer = UInt(operand1[e*:esize]);
        let dividend : integer = UInt(operand2[e*:esize]);
        var quotient : integer;
        if divisor == 0 then
            quotient = 0;
        else
            quotient = dividend DIVRM divisor;
        end;
