...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-93-TLBIP-RIPAS2E1IS--TLBIP-RIPAS2E1ISNXS--TLB-Range-Invalidate-by-Intermediate-Physical-Address--Stage-2--EL1--Inner-Shareable>
...
![](images/0601-C5.5.93-TLBIP-RIPAS2E1IS-TLBIP-RIPAS2E1ISNXS-TLB-Range-Invalidate-by-Intermediate-Physical-Address-Stage-2-EL1-Inner-Shareable-img01.svg)
...
if !(IsFeatureImplemented(FEAT_D128) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    AArch64_TLBIP_RIPAS2(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_ISH, TLBILevel_Any, TLBI_AllAttr, X{128}(t, t2));
...
if !(IsFeatureImplemented(FEAT_D128) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    AArch64_TLBIP_RIPAS2(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_ISH, TLBILevel_Any, TLBI_ExcludeXS, X{128}(t, t2));
elsif PSTATE.EL == EL3 then
    if !EL2Enabled() then
        return;
    else
