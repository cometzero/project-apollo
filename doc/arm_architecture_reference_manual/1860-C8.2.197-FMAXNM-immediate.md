...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-197-FMAXNM--immediate->
...
![](images/1860-C8.2.197-FMAXNM-immediate-img01.svg)
...
        result[e*:esize] = FPMaxNum{esize}(element1, imm, FPCR());
    else
