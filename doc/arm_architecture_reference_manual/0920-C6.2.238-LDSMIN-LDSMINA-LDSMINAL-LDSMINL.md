# ​C6.2.238 LDSMIN, LDSMINA, LDSMINAL, LDSMINL

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-238-LDSMIN--LDSMINA--LDSMINAL--LDSMINL>
...
This instruction is used by the alias [STSMIN, STSMINL](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-428-STSMIN--STSMINL?lang=en#isa_stsmin_ldsmin).

###### Integer

###### (FEAT\_LSE)

![](images/0920-C6.2.238-LDSMIN-LDSMINA-LDSMINAL-LDSMINL-img01.svg)
