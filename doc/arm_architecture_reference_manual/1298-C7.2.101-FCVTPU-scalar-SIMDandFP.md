...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-101-FCVTPU--scalar-SIMD-FP->
...
![](images/1298-C7.2.101-FCVTPU-scalar-SIMDandFP-img01.svg)
...
fltval = V{fltsize}(n);
intval = FPToFixed{intsize, fltsize}(fltval, 0, TRUE, FPCR(), FPRounding_POSINF);
