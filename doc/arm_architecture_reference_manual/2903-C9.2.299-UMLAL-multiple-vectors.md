...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-299-UMLAL--multiple-vectors->

##### C9.2.299 UMLAL (multiple vectors)

Multi-vector unsigned 16-bit integer multiply-add to 32-bit integer

This instruction multiplies each unsigned 16-bit element in the two or four first source vectors by each unsigned 16-bit element in the two or four second source vectors, widens each product to 32 bits, and destructively adds these values to the corresponding 32-bit elements of the ZA double-vector groups.
...
It has encodings from 2 classes: [Two ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-299-UMLAL--multiple-vectors-?lang=en#isa_umlal_za_zzw_iclass_two_za_double_vectors) and [Four ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-299-UMLAL--multiple-vectors-?lang=en#isa_umlal_za_zzw_iclass_four_za_double_vectors)

###### Two ZA double-vectors

###### (FEAT\_SME2)

![](images/2903-C9.2.299-UMLAL-multiple-vectors-img01.svg)
...
![](images/2903-C9.2.299-UMLAL-multiple-vectors-img02.svg)
