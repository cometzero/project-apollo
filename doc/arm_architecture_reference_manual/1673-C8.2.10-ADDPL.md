...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-10-ADDPL>
...
![](images/1673-C8.2.10-ADDPL-img01.svg)
...
let result : bits(64) = operand1 + (imm * (PL DIV 8));
if d == 31 then
    SP{64}() = result;
else
    X{64}(d) = result;
