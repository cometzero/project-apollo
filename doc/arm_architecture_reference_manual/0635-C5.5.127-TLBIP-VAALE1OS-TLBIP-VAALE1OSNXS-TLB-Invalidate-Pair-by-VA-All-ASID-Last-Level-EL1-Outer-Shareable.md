...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-127-TLBIP-VAALE1OS--TLBIP-VAALE1OSNXS--TLB-Invalidate-Pair-by-VA--All-ASID--Last-Level--EL1--Outer-Shareable>
...
Configuration
:   This system instruction is present only when FEAT\_D128 is implemented and FEAT\_AA64 is implemented. Otherwise, direct accesses to TLBIP VAALE1OS, TLBIP VAALE1OSNXS are UNDEFINED.
...
![](images/0635-C5.5.127-TLBIP-VAALE1OS-TLBIP-VAALE1OSNXS-TLB-Invalidate-Pair-by-VA-All-ASID-Last-Level-EL1-Outer-Shareable-img01.svg)
...
if !(IsFeatureImplemented(FEAT_D128) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    if EL2Enabled() && (HCR_EL2().TTLB == '1' || HCR_EL2().TTLBOS == '1') then
        ...
        AArch64_TLBIP_VAA(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_OSH, TLBILevel_Last, TLBI_AllAttr, X{128}(t, t2));
    end;
...
if !(IsFeatureImplemented(FEAT_D128) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    if EL2Enabled() && (HCR_EL2().TTLB == '1' || HCR_EL2().TTLBOS == '1') then
        ...
        AArch64_TLBIP_VAA(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_OSH, TLBILevel_Last, TLBI_ExcludeXS, X{128}(t, t2));
    end;
elsif PSTATE.EL == EL2 then
    AArch64_TLBIP_VAA(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_OSH, TLBILevel_Last, TLBI_ExcludeXS, X{128}(t, t2));
elsif PSTATE.EL == EL3 then
