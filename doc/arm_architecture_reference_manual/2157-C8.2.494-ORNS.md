...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-494-ORNS>
...
![](images/2157-C8.2.494-ORNS-img01.svg)
...
        result[e*:psize] = ZeroExtend{psize}(element1 OR (NOT element2));
    else
