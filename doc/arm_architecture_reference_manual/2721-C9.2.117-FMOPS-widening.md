...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-117-FMOPS--widening->
...
![](images/2721-C9.2.117-FMOPS-widening-img01.svg)
...
                                        else FPZero{16}(‘0’));
            if prow_0 then erow_0 = FPNeg{16}(erow_0, FPCR()); end;
            if prow_1 then erow_1 = FPNeg{16}(erow_1, FPCR()); end;
