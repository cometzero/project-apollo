# ​C6.2.240 LDSMINH, LDSMINAH, LDSMINALH, LDSMINLH

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-240-LDSMINH--LDSMINAH--LDSMINALH--LDSMINLH>
...
This instruction is used by the alias [STSMINH, STSMINLH](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-430-STSMINH--STSMINLH?lang=en#isa_stsminh_ldsminh).

###### Integer

###### (FEAT\_LSE)

![](images/0922-C6.2.240-LDSMINH-LDSMINAH-LDSMINALH-LDSMINLH-img01.svg)
