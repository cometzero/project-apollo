...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-60-FAMAX>
...
It has encodings from 2 classes: [Two registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-60-FAMAX?lang=en#isa_famax_mz_zzw_iclass_two_registers) and [Four registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-60-FAMAX?lang=en#isa_famax_mz_zzw_iclass_four_registers)

###### Two registers

###### (FEAT\_SME2 && FEAT\_FAMINMAX)

![](images/2664-C9.2.60-FAMAX-img01.svg)
...
![](images/2664-C9.2.60-FAMAX-img02.svg)
...
        results[[r]][e*:esize] = FPAbsMax{esize}(element1, element2, FPCR());
    end;
end;
for r = 0 to nreg-1 do
    Z{VL}(dn+r) = results[[r]];
