...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-203-FMAXQV>
...
![](images/1866-C8.2.203-FMAXQV-img01.svg)
...
let identity : bits(esize) = FPInfinity{esize}(‘1’);
...
        end;
    end;
    result[e*:esize] = FPReduce{esize, segbits}(ReduceOp_FMAX, stmp, FPCR());
end;
V{128}(d) = result;
```
