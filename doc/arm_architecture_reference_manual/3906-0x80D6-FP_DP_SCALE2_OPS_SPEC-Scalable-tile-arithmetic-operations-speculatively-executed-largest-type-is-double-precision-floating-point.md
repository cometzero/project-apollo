...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-3-Common-event-numbers/-0x80D6--FP-DP-SCALE2-OPS-SPEC--Scalable-tile-arithmetic-operations-speculatively-executed--largest-type-is-double-precision-floating-point>

##### `0x80D6`, FP\_DP\_SCALE2\_OPS\_SPEC, Scalable tile arithmetic operations speculatively executed, largest type is double-precision floating-point

The counter increments by *v* for each [speculatively executed](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-1-Definitions/-D14-1-1-Definition-of-terms?lang=en#cacijece) scalable tile arithmetic operation, due to an instruction where the largest type was double-precision floating-point.
