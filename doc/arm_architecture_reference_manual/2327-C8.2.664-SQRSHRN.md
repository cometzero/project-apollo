...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-664-SQRSHRN>
...
![](images/2327-C8.2.664-SQRSHRN-img01.svg)
...
        result[(2*e + i)*:esize] = SignedSat{esize}(res);
    end;
end;
Z{VL}(d) = result;
```
