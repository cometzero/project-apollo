# ​C6.2.242 LDTCLR, LDTCLRA, LDTCLRAL, LDTCLRL

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-242-LDTCLR--LDTCLRA--LDTCLRAL--LDTCLRL>
...
This instruction is used by the alias [STTCLR, STTCLRL](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-432-STTCLR--STTCLRL?lang=en#isa_sttclr_ldtclr).

###### Integer

###### (FEAT\_LSUI)

![](images/0924-C6.2.242-LDTCLR-LDTCLRA-LDTCLRAL-LDTCLRL-img01.svg)
