...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-14-TLBI-IPAS2E1IS--TLBI-IPAS2E1ISNXS--TLB-Invalidate-by-Intermediate-Physical-Address--Stage-2--EL1--Inner-Shareable>
...
![](images/0522-C5.5.14-TLBI-IPAS2E1IS-TLBI-IPAS2E1ISNXS-TLB-Invalidate-by-Intermediate-Physical-Address-Stage-2-EL1-Inner-Shareable-img01.svg)
...
if !IsFeatureImplemented(FEAT_AA64) then
    ...
    AArch64_TLBI_IPAS2(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_ISH, TLBILevel_Any, TLBI_AllAttr, X{64}(t));
...
`When FEAT_XS is implemented TLBI IPAS2E1ISNXS{, <Xt>}`
:
  ...
  <tr>
   ...
   <td>
    ...
    if !IsFeatureImplemented(FEAT_AA64) then
        ...
        AArch64_TLBI_IPAS2(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_ISH, TLBILevel_Any, TLBI_ExcludeXS, X{64}(t));
    elsif PSTATE.EL == EL3 then
        if !EL2Enabled() then
            return;
        else
