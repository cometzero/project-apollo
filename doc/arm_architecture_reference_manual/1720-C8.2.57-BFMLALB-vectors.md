...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-57-BFMLALB--vectors->
...
![](images/1720-C8.2.57-BFMLALB-vectors-img01.svg)
...
                               else op1[(2*e + 0)*:16]);
    let elem2 : bits(16) = op2[(2*e + 0)*:16];
