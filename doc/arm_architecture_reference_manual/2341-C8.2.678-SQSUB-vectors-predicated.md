...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-678-SQSUB--vectors--predicated->
...
![](images/2341-C8.2.678-SQSUB-vectors-predicated-img01.svg)
...
        result[e*:esize] = SignedSat{esize}(element1 - element2);
    else
