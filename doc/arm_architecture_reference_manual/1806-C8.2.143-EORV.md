...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-143-EORV>

##### C8.2.143 EORV

Bitwise exclusive-OR reduction to scalar

This instruction performs a bitwise exclusive-OR between the elements of the source vector, and places the result in the SIMD&FP scalar destination register. Inactive elements in the source vector are treated as zero.

###### SVE

###### (FEAT\_SVE || FEAT\_SME)

![](images/1806-C8.2.143-EORV-img01.svg)
...
        result = result XOR operand[e*:esize];
    end;
end;
V{esize}(d) = result;
```
