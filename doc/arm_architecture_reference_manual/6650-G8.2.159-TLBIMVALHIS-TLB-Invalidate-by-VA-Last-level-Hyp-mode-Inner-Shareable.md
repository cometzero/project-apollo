...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-G-The-AArch32-System-Level-Architecture/-Chapter-G8-AArch32-System-Register-Descriptions/-G8-2-General-system-control-registers/-G8-2-159-TLBIMVALHIS--TLB-Invalidate-by-VA--Last-level--Hyp-mode--Inner-Shareable>
...
![](images/6650-G8.2.159-TLBIMVALHIS-TLB-Invalidate-by-VA-Last-level-Hyp-mode-Inner-Shareable-img01.svg)
...
if !IsFeatureImplemented(FEAT_AA32EL2) then
    ...
    AArch32_TLBI_VA(SecurityStateAtEL(EL2), Regime_EL2, VMID_NONE, Broadcast_ISH, TLBILevel_Last, TLBI_AllAttr, R(t));
elsif PSTATE.EL == EL3 then
    if !HaveEL(EL2) then
        Undefined();
    else
        AArch32_TLBI_VA(SS_NonSecure, Regime_EL2, VMID(), Broadcast_ISH, TLBILevel_Last, TLBI_AllAttr, R(t));
    end;
end;
```
