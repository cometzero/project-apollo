...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-496-ORR--predicates->
...
This instruction is used by the alias [MOV](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-469-MOV?lang=en#isa_mov_orr_p_p_pp).

###### Not setting the condition flags

###### (FEAT\_SVE || FEAT\_SME)

![](images/2159-C8.2.496-ORR-predicates-img01.svg)
