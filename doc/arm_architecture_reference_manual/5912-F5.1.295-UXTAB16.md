...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F5-T32-and-A32-Base-Instruction-Set-Instruction-Descriptions/-F5-1-Alphabetical-list-of-T32-and-A32-base-instruction-set-instructions/-F5-1-295-UXTAB16>
...
```
if Rn == ‘1111’ then See(“UXTB16”); end;
...
![](images/5912-F5.1.295-UXTAB16-img02.svg)
...
    R(d)[15:0]  = R(n)[15:0] + ZeroExtend{16}(rotated[7:0]);
    R(d)[31:16] = R(n)[31:16] + ZeroExtend{16}(rotated[23:16]);
end;
```
