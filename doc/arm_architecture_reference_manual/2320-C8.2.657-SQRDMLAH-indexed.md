...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-657-SQRDMLAH--indexed->

##### C8.2.657 SQRDMLAH (indexed)

Signed saturating rounding doubling multiply-add high by indexed element

This instruction multiplies all signed elements within each 128-bit segment of the first source vector by the specified signed element of the corresponding second source vector segment, and then doubles the result and destructively adds the rounded high half of each result to the corresponding elements of the addend and destination vector. Each destination element is saturated to the N-bit element’s signed integer range -2(N-1) to (2(N-1))-1.
...
It has encodings from 3 classes: [16-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-657-SQRDMLAH--indexed-?lang=en#isa_sqrdmlah_z_zzzi_iclass_16_bit), [32-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-657-SQRDMLAH--indexed-?lang=en#isa_sqrdmlah_z_zzzi_iclass_32_bit), and [64-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-657-SQRDMLAH--indexed-?lang=en#isa_sqrdmlah_z_zzzi_iclass_64_bit)

###### 16-bit

###### (FEAT\_SVE2 || FEAT\_SME)

![](images/2320-C8.2.657-SQRDMLAH-indexed-img01.svg)
...
![](images/2320-C8.2.657-SQRDMLAH-indexed-img02.svg)
...
![](images/2320-C8.2.657-SQRDMLAH-indexed-img03.svg)
