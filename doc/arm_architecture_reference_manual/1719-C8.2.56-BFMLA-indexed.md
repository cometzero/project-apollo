...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-56-BFMLA--indexed->
...
![](images/1719-C8.2.56-BFMLA-indexed-img01.svg)
...
    let elem3 : bits(16) = if op3_neg then BFNeg(result[e*:16]) else result[e*:16];
