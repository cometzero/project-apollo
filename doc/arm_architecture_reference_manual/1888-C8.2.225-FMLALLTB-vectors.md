...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-225-FMLALLTB--vectors->
...
![](images/1888-C8.2.225-FMLALLTB-vectors-img01.svg)
...
    let element2 : bits(8) = operand2[(4 * e + 2)*:8];
