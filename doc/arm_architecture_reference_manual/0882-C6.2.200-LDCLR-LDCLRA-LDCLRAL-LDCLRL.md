# ​C6.2.200 LDCLR, LDCLRA, LDCLRAL, LDCLRL

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-200-LDCLR--LDCLRA--LDCLRAL--LDCLRL>
...
This instruction is used by the alias [STCLR, STCLRL](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-389-STCLR--STCLRL?lang=en#isa_stclr_ldclr).

###### Integer

###### (FEAT\_LSE)

![](images/0882-C6.2.200-LDCLR-LDCLRA-LDCLRAL-LDCLRL-img01.svg)
