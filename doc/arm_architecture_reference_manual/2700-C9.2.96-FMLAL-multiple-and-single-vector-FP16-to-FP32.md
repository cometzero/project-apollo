...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-96-FMLAL--multiple-and-single-vector--FP16-to-FP32->
...
It has encodings from 3 classes: [One ZA double-vector](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-96-FMLAL--multiple-and-single-vector--FP16-to-FP32-?lang=en#isa_fmlal_za_zzv_iclass_one_za_double_vector), [Two ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-96-FMLAL--multiple-and-single-vector--FP16-to-FP32-?lang=en#isa_fmlal_za_zzv_iclass_two_za_double_vectors), and [Four ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-96-FMLAL--multiple-and-single-vector--FP16-to-FP32-?lang=en#isa_fmlal_za_zzv_iclass_four_za_double_vectors)

###### One ZA double-vector

###### (FEAT\_SME2)

![](images/2700-C9.2.96-FMLAL-multiple-and-single-vector-FP16-to-FP32-img01.svg)
...
![](images/2700-C9.2.96-FMLAL-multiple-and-single-vector-FP16-to-FP32-img02.svg)
...
![](images/2700-C9.2.96-FMLAL-multiple-and-single-vector-FP16-to-FP32-img03.svg)

###### Encoding

```
FMLAL  ZA.S[<Wv>, <offs1>:<offs2>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H
```
