...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-590-SMAXV>

##### C8.2.590 SMAXV

Signed maximum reduction to scalar

This instruction determines the signed maximum of the elements of the source vector, and places the result in the SIMD&FP scalar destination register. Inactive elements in the source vector are treated as the minimum signed integer for the element size.

###### SVE

###### (FEAT\_SVE || FEAT\_SME)

![](images/2253-C8.2.590-SMAXV-img01.svg)
...
var maximum : integer = if unsigned then 0 else -(2^(esize-1));
