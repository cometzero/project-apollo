...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-595-SMINV>

##### C8.2.595 SMINV

Signed minimum reduction to scalar

This instruction determines the signed minimum of the elements of the source vector, and places the result in the SIMD&FP scalar destination register. Inactive elements in the source vector are treated as the maximum signed integer for the element size.

###### SVE

###### (FEAT\_SVE || FEAT\_SME)

![](images/2258-C8.2.595-SMINV-img01.svg)
