...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-681-SQSUBR>
...
![](images/2344-C8.2.681-SQSUBR-img01.svg)
...
        result[e*:esize] = SignedSat{esize}(element2 - element1);
    else
