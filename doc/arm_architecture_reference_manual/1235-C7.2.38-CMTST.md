...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-38-CMTST>
...
It has encodings from 2 classes: [Scalar](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-38-CMTST?lang=en#isa_cmtst_advsimd_iclass_scalar) and [Vector](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-38-CMTST?lang=en#isa_cmtst_advsimd_iclass_vector)

###### Scalar

###### (FEAT\_AdvSIMD)

![](images/1235-C7.2.38-CMTST-img01.svg)
...
![](images/1235-C7.2.38-CMTST-img02.svg)
...
    result[e*:esize] = if !IsZero(element1 AND element2) then Ones{esize} else Zeros{esize};
end;
V{datasize}(d) = result;
```
