...
![](images/0525-C5.5.17-TLBI-IPAS2LE1IS-TLBI-IPAS2LE1ISNXS-TLB-Invalidate-by-Intermediate-Physical-Address-Stage-2-Last-level-EL1-Inner-Shareable-img01.svg)
...
if !IsFeatureImplemented(FEAT_AA64) then
    ...
    AArch64_TLBI_IPAS2(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_ISH, TLBILevel_Last, TLBI_AllAttr, X{64}(t));
...
`When FEAT_XS is implemented TLBI IPAS2LE1ISNXS{, <Xt>}`
:
  ...
  <tr>
   ...
   <td>
    ...
    if !IsFeatureImplemented(FEAT_AA64) then
        ...
        AArch64_TLBI_IPAS2(SecurityStateAtEL(EL1), Regime_EL10, VMID(), Broadcast_ISH, TLBILevel_Last, TLBI_ExcludeXS, X{64}(t));
    elsif PSTATE.EL == EL3 then
        if !EL2Enabled() then
            return;
        else
