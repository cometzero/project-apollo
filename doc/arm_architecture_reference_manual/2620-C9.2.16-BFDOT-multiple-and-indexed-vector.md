...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-16-BFDOT--multiple-and-indexed-vector->

##### C9.2.16 BFDOT (multiple and indexed vector)

Multi-vector BFloat16 dot product by indexed element to single-precision

This instruction calculates the dot product of a pair of BF16 values held in the corresponding 32-bit elements of the two or four first source vectors and the indexed 32-bit element of the second source vector. The single-precision dot product results are destructively added to the corresponding single-precision elements of the ZA single-vector groups.
...
It has encodings from 2 classes: [Two ZA single-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-16-BFDOT--multiple-and-indexed-vector-?lang=en#isa_bfdot_za_zzi_iclass_two_za_single_vectors) and [Four ZA single-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-16-BFDOT--multiple-and-indexed-vector-?lang=en#isa_bfdot_za_zzi_iclass_four_za_single_vectors)

###### Two ZA single-vectors

###### (FEAT\_SME2)

![](images/2620-C9.2.16-BFDOT-multiple-and-indexed-vector-img01.svg)
...
![](images/2620-C9.2.16-BFDOT-multiple-and-indexed-vector-img02.svg)
