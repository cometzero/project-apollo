...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-447-USDOT--by-element->
...
![](images/1644-C7.2.447-USDOT-by-element-img01.svg)
...
        let element2 : integer = SInt(operand2[(4 * i + b)*:8]);
