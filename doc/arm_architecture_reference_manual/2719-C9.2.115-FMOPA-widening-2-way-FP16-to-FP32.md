...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-115-FMOPA--widening--2-way--FP16-to-FP32->
...
![](images/2719-C9.2.115-FMOPA-widening-2-way-FP16-to-FP32-img01.svg)
...
            let erow_0 : bits(16) = (if prow_0 then operand1[(2*row + 0)*:16]
                                        else FPZero{16}(‘0’));
            let erow_1 : bits(16) = (if prow_1 then operand1[(2*row + 1)*:16]
                                        else FPZero{16}(‘0’));
