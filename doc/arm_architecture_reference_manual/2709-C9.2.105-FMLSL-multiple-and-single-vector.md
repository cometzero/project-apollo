...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-105-FMLSL--multiple-and-single-vector->
...
It has encodings from 3 classes: [One ZA double-vector](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-105-FMLSL--multiple-and-single-vector-?lang=en#isa_fmlsl_za_zzv_iclass_one_za_double_vector), [Two ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-105-FMLSL--multiple-and-single-vector-?lang=en#isa_fmlsl_za_zzv_iclass_two_za_double_vectors), and [Four ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-105-FMLSL--multiple-and-single-vector-?lang=en#isa_fmlsl_za_zzv_iclass_four_za_double_vectors)

###### One ZA double-vector

###### (FEAT\_SME2)

![](images/2709-C9.2.105-FMLSL-multiple-and-single-vector-img01.svg)
...
![](images/2709-C9.2.105-FMLSL-multiple-and-single-vector-img02.svg)
...
![](images/2709-C9.2.105-FMLSL-multiple-and-single-vector-img03.svg)

###### Encoding

```
FMLSL  ZA.S[<Wv>, <offs1>:<offs2>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H
```
...
            let elem1 : bits(16) = FPNeg{16}(op1[(2 * e + i)*:(16)], FPCR());
