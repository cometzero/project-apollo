...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F5-T32-and-A32-Base-Instruction-Set-Instruction-Descriptions/-F5-1-Alphabetical-list-of-T32-and-A32-base-instruction-set-instructions/-F5-1-207-SMULL--SMULLS>
...
![](images/5824-F5.1.207-SMULL-SMULLS-img02.svg)
...
    let result : integer = SInt(R(n)) * SInt(R(m));
    R(dHi) = result[63:32];
    R(dLo) = result[31:0];
    if setflags then
        PSTATE.N = result[63];
