...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-789-SUQADD>
...
![](images/2452-C8.2.789-SUQADD-img01.svg)
...
        result[e*:esize] = SignedSat{esize}(SInt(element1) + UInt(element2));
    else
