# ​I5.3.7 PMCEID0, Performance Monitors Common Event Identification register 0

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-I-Memory-mapped-Components-of-the-Arm-Architecture/-Chapter-I5-External-System-Control-Register-Descriptions/-I5-3-Performance-Monitors-external-register-descriptions/-I5-3-7-PMCEID0--Performance-Monitors-Common-Event-Identification-register-0>
...
:   PMCEID0 is in the Core power domain.
    ...
    This register is present only when FEAT\_PMUv3\_EXT32 is implemented and FEAT\_PMUv3 is implemented. Otherwise, direct accesses to PMCEID0 are RES0.
...
![](images/7196-I5.3.7-PMCEID0-Performance-Monitors-Common-Event-Identification-register-0-img01.svg)
