...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-30-CMGE--register->
...
It has encodings from 2 classes: [Scalar](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-30-CMGE--register-?lang=en#isa_cmge_advsimd_reg_iclass_scalar) and [Vector](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-30-CMGE--register-?lang=en#isa_cmge_advsimd_reg_iclass_vector)

###### Scalar

###### (FEAT\_AdvSIMD)

![](images/1227-C7.2.30-CMGE-register-img01.svg)
...
![](images/1227-C7.2.30-CMGE-register-img02.svg)
...
    result[e*:esize] = if element1 >= element2 then Ones{esize} else Zeros{esize};
end;
V{datasize}(d) = result;
```
