...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-800-UABD>

##### C8.2.800 UABD

Unsigned absolute difference (predicated)

This instruction calculates the absolute difference between unsigned integer values in active elements of the first source vector and the corresponding elements of the second source vector, and destructively places the difference in the corresponding elements of the first source vector. Inactive elements in the destination vector register remain unmodified.

###### SVE

###### (FEAT\_SVE || FEAT\_SME)

![](images/2463-C8.2.800-UABD-img01.svg)
...
        result[e*:esize] = absdiff[esize-1:0];
    else
