...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-135-TLBIP-VAE3IS--TLBIP-VAE3ISNXS--TLB-Invalidate-Pair-by-VA--EL3--Inner-Shareable>
...
Configuration
:   This system instruction is present only when FEAT\_D128 is implemented and FEAT\_AA64 is implemented. Otherwise, direct accesses to TLBIP VAE3IS, TLBIP VAE3ISNXS are UNDEFINED.
...
![](images/0643-C5.5.135-TLBIP-VAE3IS-TLBIP-VAE3ISNXS-TLB-Invalidate-Pair-by-VA-EL3-Inner-Shareable-img01.svg)
...
if !(IsFeatureImplemented(FEAT_D128) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    if IsFeatureImplemented(FEAT_RME) && !ValidSecurityStateAtEL(EL3) then
        ...
        AArch64_TLBIP_VA(SecurityStateAtEL(EL3), Regime_EL3, VMID_NONE, Broadcast_ISH, TLBILevel_Any, TLBI_AllAttr, X{128}(t, t2));
    end;
end;
```
...
if !(IsFeatureImplemented(FEAT_D128) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    if IsFeatureImplemented(FEAT_RME) && !ValidSecurityStateAtEL(EL3) then
        ...
        AArch64_TLBIP_VA(SecurityStateAtEL(EL3), Regime_EL3, VMID_NONE, Broadcast_ISH, TLBILevel_Any, TLBI_ExcludeXS, X{128}(t, t2));
    end;
end;
```
