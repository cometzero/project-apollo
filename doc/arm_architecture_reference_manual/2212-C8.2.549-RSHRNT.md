...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-549-RSHRNT>
...
![](images/2212-C8.2.549-RSHRNT-img01.svg)
...
    result[(2*e + 1)*:esize] = res[esize-1:0];
end;
Z{VL}(d) = result;
```
