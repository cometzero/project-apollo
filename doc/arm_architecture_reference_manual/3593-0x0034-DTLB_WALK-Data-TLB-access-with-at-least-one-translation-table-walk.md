...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-3-Common-event-numbers/-0x0034--DTLB-WALK--Data-TLB-access-with-at-least-one-translation-table-walk>

##### `0x0034`, DTLB\_WALK, Data TLB access with at least one translation table walk

The counter counts each access counted by [L1D\_TLB](/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D14-PMU-Event-Descriptions/-D14-3-Common-event-numbers/-0x0025--L1D-TLB--Level-1-data-TLB-access?lang=en#event_l1d_tlb) that causes a refill of a data or unified TLB involving at least one translation table walk access.
