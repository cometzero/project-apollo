...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-405-UADALP>
...
![](images/1602-C7.2.405-UADALP-img01.svg)
...
    op1 = UInt(operand[(2*e+0)*:esize]);
    op2 = UInt(operand[(2*e+1)*:esize]);
