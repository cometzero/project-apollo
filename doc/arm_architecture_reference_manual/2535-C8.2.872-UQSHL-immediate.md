...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-872-UQSHL--immediate->
...
![](images/2535-C8.2.872-UQSHL-immediate-img01.svg)
...
        let res : integer = element1 << shift;
        result[e*:esize] = UnsignedSat{esize}(res);
    else
