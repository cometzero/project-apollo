...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-230-SQCVTN>
...
![](images/2834-C9.2.230-SQCVTN-img01.svg)
...
        result[(4*e + i)*:esize] = SignedSat{esize}(element);
    end;
end;
Z{VL}(d) = result;
```
