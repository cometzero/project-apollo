...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-304-UMLSL--multiple-and-single-vector->

##### C9.2.304 UMLSL (multiple and single vector)

Multi-vector unsigned 16-bit integer multiply-subtract by vector from 32-bit integer

This instruction multiplies each unsigned 16-bit element in the one, two, or four first source vectors by each unsigned 16-bit element in the second source vector, widens each product to 32 bits, and destructively subtracts these values from the corresponding 32-bit elements of the ZA double-vector groups.
...
It has encodings from 3 classes: [One ZA double-vector](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-304-UMLSL--multiple-and-single-vector-?lang=en#isa_umlsl_za_zzv_iclass_one_za_double_vector), [Two ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-304-UMLSL--multiple-and-single-vector-?lang=en#isa_umlsl_za_zzv_iclass_two_za_double_vectors), and [Four ZA double-vectors](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-304-UMLSL--multiple-and-single-vector-?lang=en#isa_umlsl_za_zzv_iclass_four_za_double_vectors)

###### One ZA double-vector

###### (FEAT\_SME2)

![](images/2908-C9.2.304-UMLSL-multiple-and-single-vector-img01.svg)
...
![](images/2908-C9.2.304-UMLSL-multiple-and-single-vector-img02.svg)
...
![](images/2908-C9.2.304-UMLSL-multiple-and-single-vector-img03.svg)
