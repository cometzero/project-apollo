...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-19-BFMAX--multiple-and-single-vector->
...
It has encodings from 2 classes: [Two registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-19-BFMAX--multiple-and-single-vector-?lang=en#isa_bfmax_mz_zzv_iclass_two_registers) and [Four registers](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-19-BFMAX--multiple-and-single-vector-?lang=en#isa_bfmax_mz_zzv_iclass_four_registers)

###### Two registers

###### (FEAT\_SME2 && FEAT\_SVE\_B16B16)

![](images/2623-C9.2.19-BFMAX-multiple-and-single-vector-img01.svg)
...
![](images/2623-C9.2.19-BFMAX-multiple-and-single-vector-img02.svg)
...
        results[[r]][e*:16] = BFMax{16}(element1, element2, FPCR());
    end;
end;
for r = 0 to nreg-1 do
    Z{VL}(dn+r) = results[[r]];
