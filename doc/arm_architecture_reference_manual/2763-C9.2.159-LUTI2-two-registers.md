...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-159-LUTI2--two-registers->
...
It has encodings from 2 classes: [Consecutive](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-159-LUTI2--two-registers-?lang=en#isa_luti2_mz2_ztz_iclass_consecutive) and [Strided](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C9-SME-Instruction-Descriptions/-C9-2-Alphabetical-list-of-SME-instructions/-C9-2-159-LUTI2--two-registers-?lang=en#isa_luti2_mz2_ztz_iclass_strided)

###### Consecutive

###### (FEAT\_SME2)

![](images/2763-C9.2.159-LUTI2-two-registers-img01.svg)
...
![](images/2763-C9.2.159-LUTI2-two-registers-img02.svg)
...
let isize : integer{} = 2;
let n : integer = UInt(Zn);
let dstride : integer = 8;
let d : integer = UInt(D::‘0’::Zd);
let imm : integer = UInt(i3);
let nreg : integer{} = 2;
```
