...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-229-FMLALT--vectors--FP8-to-FP16->
...
![](images/1892-C8.2.229-FMLALT-vectors-FP8-to-FP16-img01.svg)
...
    let element2 : bits(8) = operand2[(2 * e + 1)*:8];
