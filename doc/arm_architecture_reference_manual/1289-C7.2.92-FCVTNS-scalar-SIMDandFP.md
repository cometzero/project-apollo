...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-92-FCVTNS--scalar-SIMD-FP->
...
![](images/1289-C7.2.92-FCVTNS-scalar-SIMDandFP-img01.svg)
...
fltval = V{fltsize}(n);
intval = FPToFixed{intsize, fltsize}(fltval, 0, FALSE, FPCR(), FPRounding_TIEEVEN);
