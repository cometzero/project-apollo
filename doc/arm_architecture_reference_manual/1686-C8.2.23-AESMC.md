...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-23-AESMC>
...
![](images/1686-C8.2.23-AESMC-img01.svg)
...
    result[s*:128] = AESMixColumns(operand[s*:128]);
end;
Z{VL}(dn) = result;
```
