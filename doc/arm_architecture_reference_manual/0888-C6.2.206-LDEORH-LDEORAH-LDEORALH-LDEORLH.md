# ​C6.2.206 LDEORH, LDEORAH, LDEORALH, LDEORLH

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-206-LDEORH--LDEORAH--LDEORALH--LDEORLH>
...
This instruction is used by the alias [STEORH, STEORLH](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-394-STEORH--STEORLH?lang=en#isa_steorh_ldeorh).

###### Integer

###### (FEAT\_LSE)

![](images/0888-C6.2.206-LDEORH-LDEORAH-LDEORALH-LDEORLH-img01.svg)
