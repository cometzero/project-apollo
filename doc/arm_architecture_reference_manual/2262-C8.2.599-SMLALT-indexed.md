...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-599-SMLALT--indexed->

##### C8.2.599 SMLALT (indexed)

Signed multiply-add long by indexed element (top)

This instruction multiplies the odd-numbered signed elements within each 128-bit segment of the first source vector by the specified signed element in the corresponding second source vector segment, and destructively adds the results to the overlapping double-width elements of the addend vector.
...
It has encodings from 2 classes: [32-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-599-SMLALT--indexed-?lang=en#isa_smlalt_z_zzzi_iclass_32_bit) and [64-bit](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-599-SMLALT--indexed-?lang=en#isa_smlalt_z_zzzi_iclass_64_bit)

###### 32-bit

###### (FEAT\_SVE2 || FEAT\_SME)

![](images/2262-C8.2.599-SMLALT-indexed-img01.svg)
...
![](images/2262-C8.2.599-SMLALT-indexed-img02.svg)
