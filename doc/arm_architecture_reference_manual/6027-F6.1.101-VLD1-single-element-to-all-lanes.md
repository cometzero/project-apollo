...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-101-VLD1--single-element-to-all-lanes->
...
It has encodings from the following instruction sets: A32 ([A1](/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-101-VLD1--single-element-to-all-lanes-?lang=en#isa_vld1_a_iclass_a1)) and T32 ([T1](/documentation/ddi0487/mc/-Part-F-The-AArch32-Instruction-Sets/-Chapter-F6-T32-and-A32-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-F6-1-Alphabetical-list-of-Advanced-SIMD-and-floating-point-instructions/-F6-1-101-VLD1--single-element-to-all-lanes-?lang=en#isa_vld1_a_iclass_t1)).

###### A1

![](images/6027-F6.1.101-VLD1-single-element-to-all-lanes-img01.svg)
...
```
if size == ‘11’ || (size == ‘00’ && a == ‘1’) then Undefined(); end;
let ebytes : integer{} = 1 << UInt(size);
let regs : integer = if T == ‘0’ then 1 else 2;
let alignment : integer{} = if a == ‘0’ then 1 else ebytes;
...
![](images/6027-F6.1.101-VLD1-single-element-to-all-lanes-img02.svg)
...
        AArch32_Abort(fault);
    end;
    let esize : integer{} = 8 * ebytes;
    let element : bits(esize) = MemU{8*ebytes}(address);
    let replicated_element : bits(64) = Replicate{}(element);
