...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-786-SUBR--immediate->
...
![](images/2449-C8.2.786-SUBR-immediate-img01.svg)
...
    result[e*:esize] = (imm - element1)[esize-1:0];
end;
Z{VL}(dn) = result;
```
