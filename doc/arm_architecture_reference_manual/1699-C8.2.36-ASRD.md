...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-36-ASRD>
...
![](images/1699-C8.2.36-ASRD-img01.svg)
...
        var element1 : integer = SInt(operand1[e*:esize]);
        if element1 < 0 then
            element1 = element1 + ((1 << shift) - 1);
        end;
        result[e*:esize] = (element1 >> shift)[esize-1:0];
    else
