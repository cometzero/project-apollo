...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C5-The-A64-System-Instruction-Class/-C5-5-A64-System-instructions-for-TLB-maintenance/-C5-5-41-TLBI-RVAE3--TLBI-RVAE3NXS--TLB-Range-Invalidate-by-VA--EL3>
...
Configuration
:   This system instruction is present only when FEAT\_TLBIRANGE is implemented and FEAT\_AA64 is implemented. Otherwise, direct accesses to TLBI RVAE3, TLBI RVAE3NXS are UNDEFINED.
...
![](images/0549-C5.5.41-TLBI-RVAE3-TLBI-RVAE3NXS-TLB-Range-Invalidate-by-VA-EL3-img01.svg)
...
if !(IsFeatureImplemented(FEAT_TLBIRANGE) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    if IsFeatureImplemented(FEAT_RME) && !ValidSecurityStateAtEL(EL3) then
        ...
        AArch64_TLBI_RVA(SecurityStateAtEL(EL3), Regime_EL3, VMID_NONE, Broadcast_NSH, TLBILevel_Any, TLBI_AllAttr, X{64}(t));
    end;
end;
```

`When FEAT_XS is implemented TLBI RVAE3NXS{, <Xt>}`
:
   ...
   <td>
    ...
    if !(IsFeatureImplemented(FEAT_TLBIRANGE) && IsFeatureImplemented(FEAT_AA64)) then
        ...
        if IsFeatureImplemented(FEAT_RME) && !ValidSecurityStateAtEL(EL3) then
            ...
            AArch64_TLBI_RVA(SecurityStateAtEL(EL3), Regime_EL3, VMID_NONE, Broadcast_NSH, TLBILevel_Any, TLBI_ExcludeXS, X{64}(t));
        end;
    end;
    ```
