...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-15-AND--shifted-register->
...
![](images/0697-C6.2.15-AND-shifted-register-img01.svg)
...
X{datasize}(d) = operand1 AND operand2;
```
