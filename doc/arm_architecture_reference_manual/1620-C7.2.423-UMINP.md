...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C7-A64-Advanced-SIMD-and-Floating-point-Instruction-Descriptions/-C7-2-Alphabetical-list-of-A64-Advanced-SIMD-and-floating-point-instructions/-C7-2-423-UMINP>
...
![](images/1620-C7.2.423-UMINP-img01.svg)
...
    element1 = UInt(concat[(2*e)*:esize]);
    element2 = UInt(concat[((2*e)+1)*:esize]);
