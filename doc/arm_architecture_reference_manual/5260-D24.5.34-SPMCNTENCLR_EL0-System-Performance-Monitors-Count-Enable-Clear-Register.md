# ​D24.5.34 SPMCNTENCLR_EL0, System Performance Monitors Count Enable Clear Register

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-D-The-AArch64-System-Level-Architecture/-Chapter-D24-AArch64-System-Register-Descriptions/-D24-5-Performance-Monitors-registers/-D24-5-34-SPMCNTENCLR-EL0--System-Performance-Monitors-Count-Enable-Clear-Register>

##### D24.5.34 SPMCNTENCLR\_EL0, System Performance Monitors Count Enable Clear Register
...
![](images/5260-D24.5.34-SPMCNTENCLR_EL0-System-Performance-Monitors-Count-Enable-Clear-Register-img01.svg)
...
<table>
 ...
 <tbody>
  <tr>
   ...
   <td>
    <p>
     Event counter &lt;m&gt; in System PMU &lt;s&gt; is disabled.
    </p>
   </td>
  </tr>
  <tr>
   ...
   <td>
    <p>
     Event counter &lt;m&gt; in System PMU &lt;s&gt; is enabled.
    </p>
   </td>
  </tr>
 </tbody>
...
if !(IsFeatureImplemented(FEAT_SPMU) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    if MDSCR_EL1().EnSPM == '0' then
        ...
        AArch64_SystemAccessTraptoEL1orEL2(0x18);
    elsif EL2Enabled() && EffectivelyAtEL0NotInHost() && IsFeatureImplemented(FEAT_FGT2) && ((HaveEL(EL3) && SCR_EL3().FGTEn2 == '0') || HDFGRTR2_EL2().nSPMCNTEN == '0') then
    ...
    if EL2Enabled() && IsFeatureImplemented(FEAT_FGT2) && ((HaveEL(EL3) && SCR_EL3().FGTEn2 == '0') || HDFGRTR2_EL2().nSPMCNTEN == '0') then
        AArch64_SystemAccessTrap(EL2, 0x18);
    elsif EL2Enabled() && MDCR_EL2().EnSPM == '0' then
        AArch64_SystemAccessTrap(EL2, 0x18);
    elsif EL2Enabled() && SPMACCESSR_EL2()[UInt(SPMSELR_EL0().SYSPMUSEL) * 2+:2] == '00' then
...
if !(IsFeatureImplemented(FEAT_SPMU) && IsFeatureImplemented(FEAT_AA64)) then
    ...
    if MDSCR_EL1().EnSPM == '0' then
        ...
        AArch64_SystemAccessTraptoEL1orEL2(0x18);
    elsif EL2Enabled() && EffectivelyAtEL0NotInHost() && IsFeatureImplemented(FEAT_FGT2) && ((HaveEL(EL3) && SCR_EL3().FGTEn2 == '0') || HDFGWTR2_EL2().nSPMCNTEN == '0') then
        AArch64_SystemAccessTrap(EL2, 0x18);
    elsif EL2Enabled() && MDCR_EL2().EnSPM == '0' then
        AArch64_SystemAccessTrap(EL2, 0x18);
    ...
    if EL2Enabled() && IsFeatureImplemented(FEAT_FGT2) && ((HaveEL(EL3) && SCR_EL3().FGTEn2 == '0') || HDFGWTR2_EL2().nSPMCNTEN == '0') then
        AArch64_SystemAccessTrap(EL2, 0x18);
    elsif EL2Enabled() && MDCR_EL2().EnSPM == '0' then
        AArch64_SystemAccessTrap(EL2, 0x18);
    elsif EL2Enabled() && SPMACCESSR_EL2()[UInt(SPMSELR_EL0().SYSPMUSEL) * 2+:2] != '11' then
