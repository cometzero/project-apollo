...
Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C8-SVE-Instruction-Descriptions/-C8-2-Alphabetical-list-of-SVE-instructions/-C8-2-589-SMAXQV>
...
![](images/2252-C8.2.589-SMAXQV-img01.svg)
...
            stmp = operand[s*:128];
            dtmp = Max(dtmp, SInt(stmp[e*:esize]));
        end;
    end;
