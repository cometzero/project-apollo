# ​C6.2.458 SUB (shifted register)

Source: <https://developer.arm.com/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-458-SUB--shifted-register->
...
This instruction is used by the alias [NEG (shifted register)](/documentation/ddi0487/mc/-Part-C-The-AArch64-Instruction-Set/-Chapter-C6-A64-Base-Instruction-Descriptions/-C6-2-Alphabetical-list-of-A64-base-instructions/-C6-2-295-NEG--shifted-register-?lang=en#isa_neg_sub_addsub_shift).

![](images/1140-C6.2.458-SUB-shifted-register-img01.svg)
...
(result, -) = AddWithCarry{datasize}(operand1, operand2, ‘1’);
X{datasize}(d) = result;
```
