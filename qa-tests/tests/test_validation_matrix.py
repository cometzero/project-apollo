...
APPROVED_FVP_SELECTORS: dict[str, tuple[str, ...]] = {
    ...
    "trusted-services": ("test_00_fvp_boot", "test_00_linux_boot", "test_80_trusted_services"),
    ...
    "crypto-extension": ("test_00_fvp_boot", "test_00_linux_boot", "test_65_linux_crypto"),
